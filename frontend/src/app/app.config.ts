...
export const appConfig: ApplicationConfig = {
  providers: [
    ...
    // Translation — choose ONE block based on selected packages:
    ...
    // [IF localization NOT selected] replace the block above with:
    provideFallbackMessagesRegistry(),

    // Feature providers — remove any whose package is not selected
    ...provideAuthLayoutIntegration(),
    ...provideAuthProviders(),
    ...provideIamProviders(),
