...
import { TASK_MANAGER_ROUTES } from "@flusys/ng-task-manager";
...
export const routes: Routes = [
  ...
  // Protected routes with layout
  {
    ...
    children: [
      ...
      // Task Manager (Boards, Lists, Tickets)
      {
        path: "task-manager",
        children: TASK_MANAGER_ROUTES,
      },

      // AI Assistant (Pinned Results, Chat History)
      {
        path: "ai-assistant",
