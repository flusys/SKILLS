...
const ENABLE_TASK_MANAGER = true;
...
const MODULE_CONFIGS: ModuleConfig[] = [
  ...
  { name: 'storage', messages: STORAGE_MESSAGES, readOnly: true, enabled: ENABLE_STORAGE },
  { name: 'email', messages: EMAIL_MESSAGES, readOnly: true, enabled: ENABLE_EMAIL },
  {
    name: 'formBuilder',
...
export const BENGALI_TRANSLATIONS = {
  ...
  'menu.projects': 'প্রকল্পসমূহ',
  'menu.projects.active': 'সক্রিয় প্রকল্প',
  'menu.projects.archived': 'আর্কাইভড',
  'menu.projects.reports': 'রিপোর্ট',
...
export const ARABIC_TRANSLATIONS = {
  ...
  'menu.projects.active': 'المشاريع النشطة',
  'menu.projects.archived': 'المؤرشفة',
  'menu.projects.reports': 'التقارير',
