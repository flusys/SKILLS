...
const SHARED_MESSAGES: Record<string, string> = {
  ...
  "shared.required": "is required",
  "shared.verified": "Verified",
  "shared.unverified": "Un-Verified",
  "shared.view": "View",
...
const FORM_BUILDER_MESSAGES: Record<string, string> = {
  ...
  "form.builder.subtitle": "Create and manage your forms",
  ...
  "form.builder.tab.fields": "Fields",
  "form.builder.tab.canvas": "Canvas",
  "form.builder.tab.properties": "Properties",
  "form.builder.details.general.settings": "General",
  "form.builder.details.access.response.settings": "Access & Responses",
  ...
  "form.builder.details.tags": "Tags",
  "form.builder.details.tags.placeholder": "e.g., survey, review",
  "form.builder.details.tags.hint":
    "Labels to help categorize and organize this form",
  ...
  "form.builder.mobile.tab.fields": "Fields",
  "form.builder.mobile.tab.canvas": "Canvas",
  "form.builder.mobile.tab.properties": "Edit",
...
const NOTIFICATION_MESSAGES = {
  ...
  "notification.subtitle": "Stay up to date with your latest activity",
...
const TASK_MANAGER_MESSAGES: Record<string, string> = {
  // Board API messages
  "task.board.not.found": "Board not found",
  "task.board.create.success": "Board created successfully",
  "task.board.create.many.success": "Boards created successfully",
  "task.board.get.success": "Board retrieved successfully",
  "task.board.get.all.success": "Boards retrieved successfully",
  "task.board.update.success": "Board updated successfully",
  "task.board.update.many.success": "Boards updated successfully",
  "task.board.delete.success": "Board deleted successfully",
  "task.board.restore.success": "Board restored successfully",
  "task.board.member.added": "Member added to board",
  "task.board.member.removed": "Member removed from board",
  "task.board.member.not.found": "Board member not found",
  "task.board.member.already.exists": "User is already a board member",
  "task.board.member.get.all.success": "Board members retrieved successfully",

  // List API messages
  "task.list.not.found": "List not found",
  "task.list.create.success": "List created successfully",
  "task.list.create.many.success": "Lists created successfully",
  "task.list.get.success": "List retrieved successfully",
  "task.list.get.all.success": "Lists retrieved successfully",
  "task.list.update.success": "List updated successfully",
  "task.list.update.many.success": "Lists updated successfully",
  "task.list.delete.success": "List deleted successfully",
  "task.list.restore.success": "List restored successfully",
  "task.list.reorder.success": "Lists reordered successfully",

  // Task API messages
  "task.not.found": "Task not found",
  "task.create.success": "Task created successfully",
  "task.create.many.success": "Tasks created successfully",
  "task.get.success": "Task retrieved successfully",
  "task.get.all.success": "Tasks retrieved successfully",
  "task.update.success": "Task updated successfully",
  "task.update.many.success": "Tasks updated successfully",
  "task.delete.success": "Task deleted successfully",
  "task.restore.success": "Task restored successfully",
  "task.move.success": "Task moved successfully",
  "task.assign.success": "Task assigned successfully",
  "task.assignee.not.board.member": "Assignee is not a board member",

  // Label API messages
  "task.label.not.found": "Label not found",
  "task.label.create.success": "Label created successfully",
  "task.label.create.many.success": "Labels created successfully",
  "task.label.get.success": "Label retrieved successfully",
  "task.label.get.all.success": "Labels retrieved successfully",
  "task.label.update.success": "Label updated successfully",
  "task.label.update.many.success": "Labels updated successfully",
  "task.label.delete.success": "Label deleted successfully",
  "task.label.restore.success": "Label restored successfully",

  // Comment API messages
  "task.comment.not.found": "Comment not found",
  "task.comment.create.success": "Comment added successfully",
  "task.comment.create.many.success": "Comments added successfully",
  "task.comment.get.success": "Comment retrieved successfully",
  "task.comment.get.all.success": "Comments retrieved successfully",
  "task.comment.update.success": "Comment updated successfully",
  "task.comment.update.many.success": "Comments updated successfully",
  "task.comment.delete.success": "Comment deleted successfully",
  "task.comment.restore.success": "Comment restored successfully",

  // pages/board-list-page/board-list-page.component.ts
  "task.manager.boards.title": "Task Boards",
  "task.manager.boards.subtitle": "Manage and organize your project boards",
  "task.manager.board.new": "New Board",
  "task.manager.board.name.placeholder": "e.g. Product Backlog",
  "task.manager.board.description.placeholder": "Optional description",
  "task.manager.board.color.label": "Board Color",
  "task.manager.board.empty": "No boards yet",
  "task.manager.board.empty.hint": "Create your first board to get started",
  "task.manager.board.members": "Members",
  "task.manager.board.lists": "Lists",
  "task.manager.board.tasks": "Tasks",

  // pages/board-view-page/board-view-page.component.ts
  "task.manager.board.add.list": "Add List",
  "task.manager.board.add.task": "Add task",
  "task.manager.board.drop.tasks.here": "Drop tasks here",
  "task.manager.board.list.empty":
    'No lists yet. Click "Add List" to create one.',
  "task.manager.list.new": "New List",
  "task.manager.list.name.label": "List Name",
  "task.manager.list.name.placeholder": "e.g. In Progress",
  "task.manager.list.rename": "Rename List",

  // Member management
  "task.manager.board.manage.members": "Members",
  "task.manager.member.manage.title": "Manage Members",
  "task.manager.member.add": "Add Member",
  "task.manager.member.no.members": "No members yet.",
  "task.manager.member.user.label": "User",
  "task.manager.member.user.placeholder": "Search by name or email",
  "task.manager.member.role.label": "Role",
  "task.manager.member.role.placeholder": "Select role",
  "task.manager.member.role.owner": "Owner",
  "task.manager.member.role.admin": "Admin",
  "task.manager.member.role.member": "Member",
  "task.manager.member.role.viewer": "Viewer",

  // Label management
  "task.manager.board.manage.labels": "Labels",
  "task.manager.label.manage.title": "Manage Labels",
  "task.manager.label.name.label": "Label Name",
  "task.manager.label.name.placeholder": "e.g. Bug, Feature",
  "task.manager.label.color.label": "Color",
  "task.manager.label.add": "Add Label",
  "task.manager.label.no.labels": "No labels yet.",

  "task.manager.board.edit": "Edit Board",
  "task.manager.board.name.label": "Board Name",
  "task.manager.board.description.label": "Description",

  // View toggle
  "task.manager.view.board": "Board",
  "task.manager.view.list": "List",

  // Table/list view
  "task.manager.table.title": "Title",
  "task.manager.table.list": "List",
  "task.manager.table.priority": "Priority",
  "task.manager.table.assignee": "Assignee",
  "task.manager.table.due.date": "Due Date",
  "task.manager.table.empty": "No tasks yet.",

  // components/task-form-dialog/task-form-dialog.component.ts
  "task.form.title.create": "New Task",
  "task.form.title.edit": "Edit Task",
  "task.form.title.label": "Title",
  "task.form.title.placeholder": "Task title",
  "task.form.description.placeholder": "Add a description...",
  "task.form.priority.label": "Priority",
  "task.form.priority.placeholder": "Select priority",
  "task.form.due.date.label": "Due Date",
  "task.form.due.date.placeholder": "Pick a date",
  "task.form.assignee.label": "Assignee",
  "task.form.assignee.placeholder": "Assign to board member",
  "task.form.labels.label": "Labels",
  "task.form.labels.placeholder": "Select labels",
  ...
  // components/task-detail-panel/task-detail-panel.component.ts
  "task.detail.description.empty": "No description",
  "task.detail.comments.label": "Comments",
  "task.detail.comments.empty": "No comments yet",
  "task.detail.comment.placeholder": "Add a comment...",
  "task.detail.due.label": "Due",
  "task.detail.assignees.label": "Assignees",
  "task.detail.edit": "Edit task",
  "task.detail.delete": "Delete task",
  "task.comment.reply": "Reply",
  "task.comment.reply.placeholder": "Write a reply...",
  "task.comment.forbidden": "Cannot edit another user's comment",
};

const AI_ASSISTANT_MESSAGES: Record<string, string> = {
  // Backend API messages (nestjs-ai-assistant config/message-keys.ts)
  "ai-assistant.chat.success": "Chat reply generated",
  "ai-assistant.pin.not.found": "Pinned result not found",
  "ai-assistant.pin.success": "Result pinned",
  "ai-assistant.sync.success": "Pin synced",
  "ai-assistant.sync.unsupported": "This pin doesn't support syncing",
  "ai-assistant.pinned.get.all.success": "Pinned results retrieved",
  "ai-assistant.history.get.all.success": "Chat history retrieved",
  "ai-assistant.history.forbidden.all":
    "Not permitted to view all users chat history",
  "ai-assistant.tool.execution.failed": "Tool execution failed",

  // Frontend UI strings (ng-ai-assistant pages/components)
  // Note: 'ai-assistant.widget.*' keys live in LAYOUT_MESSAGES instead — the chat
  // widget is mounted globally in app-root, outside this lazy-loaded module.
  "ai-assistant.title": "AI Assistant",
  "ai-assistant.subtitle":
    "Chat with the assistant and revisit your pinned results",

  "ai-assistant.tabs.chat": "Chat",
  "ai-assistant.tabs.pinned": "Pinned",

  "ai-assistant.chat.new": "New chat",
  "ai-assistant.chat.show-all": "Show all users' chats",
  "ai-assistant.chat.filter.all": "All users",
  "ai-assistant.chat.filter.user": "Specific user",
  "ai-assistant.chat.filter.anonymous": "Anonymous",
  "ai-assistant.chat.filter.user-placeholder": "Search users...",
  "ai-assistant.chat.anonymous": "Anonymous",
  "ai-assistant.chat.empty-list": "No conversations yet",
  "ai-assistant.chat.untitled": "New conversation",
  "ai-assistant.chat.greeting": "How can I help you today?",
  "ai-assistant.chat.greeting-hint":
    "Start a new conversation or pick one from the sidebar",
  "ai-assistant.chat.readonly-banner":
    "Viewing {{user}}'s conversation (read-only)",

  "ai-assistant.pinned.empty": "No pinned results yet",
  "ai-assistant.pinned.empty.hint":
    "Pin a reply from the assistant chat to see it here",
  "ai-assistant.pinned.sync": "Sync",
  "ai-assistant.pinned.sync-count": "syncs",
  "ai-assistant.pinned.sync-history": "Sync history",
  "ai-assistant.pinned.prompt": "Asked",
  "ai-assistant.pinned.select-hint":
    "Select a pinned result from the list to view it",
};
...
const MODULE_CONFIGS: ModuleConfig[] = [
  ...
  { name: "email", messages: EMAIL_MESSAGES, readOnly: true, enabled: true },
  {
    name: "formBuilder",
  ...
  {
    name: "task-manager",
    messages: TASK_MANAGER_MESSAGES,
    readOnly: true,
    enabled: true,
  },
  {
...
export const BENGALI_TRANSLATIONS = {
  ...
  "error.conflict": "এই {{field}} সহ {{entity}} ইতিমধ্যে বিদ্যমান",
  "error.db.foreign.key": "'{{field}}' এর জন্য অবৈধ রেফারেন্স",
  "error.db.not.null": "প্রয়োজনীয় ফিল্ড '{{field}}' null হতে পারবে না",
  "error.db.invalid.input": "অবৈধ {{type}} মান",
  "error.db.value.too.long": "'{{field}}' এর জন্য মান অনেক বড়",
  "error.db.check.constraint": "{{entity}} একটি যাচাইকরণ নিয়ম লঙ্ঘন করেছে",
  "error.db.deadlock":
    "দ্বন্দ্বের কারণে অনুরোধটি সম্পন্ন করা যায়নি, অনুগ্রহ করে আবার চেষ্টা করুন",
  ...
  "shared.no.data": "কোনো ডেটা পাওয়া যায়নি",
  ...
  "shared.pagination.report":
    "{first} থেকে {last} পর্যন্ত দেখানো হচ্ছে, মোট {totalRecords}",
  ...
  "shared.required": "প্রয়োজন",
  "shared.verified": "যাচাইকৃত",
  "shared.unverified": "যাচাই করা হয়নি",
  "shared.view": "দেখুন",
  ...
  "layout.launcher.no.apps": "কোনো অ্যাপ উপলব্ধ নেই",
  ...
  "menu.task.manager": "টাস্ক ম্যানেজার",
  "menu.ai.assistant": "এআই সহায়ক",
  ...
  "form.builder.subtitle": "আপনার ফর্ম তৈরি ও পরিচালনা করুন",
  ...
  "form.builder.tab.fields": "ফিল্ড",
  "form.builder.tab.canvas": "ক্যানভাস",
  "form.builder.tab.properties": "বৈশিষ্ট্য",
  "form.builder.details.general.settings": "সাধারণ",
  "form.builder.details.access.response.settings": "অ্যাক্সেস ও প্রতিক্রিয়া",
  ...
  "form.builder.details.tags": "ট্যাগ",
  "form.builder.details.tags.placeholder": "যেমন, জরিপ, পর্যালোচনা",
  "form.builder.details.tags.hint":
    "এই ফর্মটি শ্রেণীবদ্ধ ও সংগঠিত করতে সহায়ক লেবেল",
  ...
  "form.builder.mobile.tab.fields": "ফিল্ড",
  "form.builder.mobile.tab.canvas": "ক্যানভাস",
  "form.builder.mobile.tab.properties": "সম্পাদনা",
  ...
  "notification.subtitle": "আপনার সর্বশেষ কার্যক্রমের সাথে আপডেট থাকুন",
  "notification.empty.title": "এখনো কোনো বিজ্ঞপ্তি নেই",
  "notification.empty.subtitle": "আপনি সব আপডেট!",

  "task.board.not.found": "বোর্ড পাওয়া যায়নি",
  "task.board.create.success": "বোর্ড সফলভাবে তৈরি হয়েছে",
  "task.board.create.many.success": "বোর্ডগুলো সফলভাবে তৈরি হয়েছে",
  "task.board.get.success": "বোর্ড সফলভাবে পুনরুদ্ধার হয়েছে",
  "task.board.get.all.success": "বোর্ডগুলো সফলভাবে পুনরুদ্ধার হয়েছে",
  "task.board.update.success": "বোর্ড সফলভাবে হালনাগাদ হয়েছে",
  "task.board.update.many.success": "বোর্ডগুলো সফলভাবে হালনাগাদ হয়েছে",
  "task.board.delete.success": "বোর্ড সফলভাবে মুছে ফেলা হয়েছে",
  "task.board.restore.success": "বোর্ড সফলভাবে পুনরায় সক্রিয় হয়েছে",
  "task.board.member.added": "সদস্য বোর্ডে যোগ করা হয়েছে",
  "task.board.member.removed": "সদস্য বোর্ড থেকে সরানো হয়েছে",
  "task.board.member.not.found": "বোর্ড সদস্য পাওয়া যায়নি",
  "task.board.member.already.exists": "ব্যবহারকারী ইতিমধ্যে বোর্ড সদস্য",
  "task.board.member.get.all.success":
    "বোর্ড সদস্যরা সফলভাবে পুনরুদ্ধার হয়েছে",

  "task.list.not.found": "তালিকা পাওয়া যায়নি",
  "task.list.create.success": "তালিকা সফলভাবে তৈরি হয়েছে",
  "task.list.create.many.success": "তালিকাগুলো সফলভাবে তৈরি হয়েছে",
  "task.list.get.success": "তালিকা সফলভাবে পুনরুদ্ধার হয়েছে",
  "task.list.get.all.success": "তালিকাগুলো সফলভাবে পুনরুদ্ধার হয়েছে",
  "task.list.update.success": "তালিকা সফলভাবে হালনাগাদ হয়েছে",
  "task.list.update.many.success": "তালিকাগুলো সফলভাবে হালনাগাদ হয়েছে",
  "task.list.delete.success": "তালিকা সফলভাবে মুছে ফেলা হয়েছে",
  "task.list.restore.success": "তালিকা সফলভাবে পুনরায় সক্রিয় হয়েছে",
  "task.list.reorder.success": "তালিকাগুলো সফলভাবে পুনর্বিন্যস্ত হয়েছে",

  "task.not.found": "টাস্ক পাওয়া যায়নি",
  "task.create.success": "টাস্ক সফলভাবে তৈরি হয়েছে",
  "task.create.many.success": "টাস্কগুলো সফলভাবে তৈরি হয়েছে",
  "task.get.success": "টাস্ক সফলভাবে পুনরুদ্ধার হয়েছে",
  "task.get.all.success": "টাস্কগুলো সফলভাবে পুনরুদ্ধার হয়েছে",
  "task.update.success": "টাস্ক সফলভাবে হালনাগাদ হয়েছে",
  "task.update.many.success": "টাস্কগুলো সফলভাবে হালনাগাদ হয়েছে",
  "task.delete.success": "টাস্ক সফলভাবে মুছে ফেলা হয়েছে",
  "task.restore.success": "টাস্ক সফলভাবে পুনরায় সক্রিয় হয়েছে",
  "task.move.success": "টাস্ক সফলভাবে সরানো হয়েছে",
  "task.assign.success": "টাস্ক সফলভাবে বরাদ্দ হয়েছে",
  "task.assignee.not.board.member": "বরাদ্দকারী বোর্ড সদস্য নন",

  "task.label.not.found": "লেবেল পাওয়া যায়নি",
  "task.label.create.success": "লেবেল সফলভাবে তৈরি হয়েছে",
  "task.label.create.many.success": "লেবেলগুলো সফলভাবে তৈরি হয়েছে",
  "task.label.get.success": "লেবেল সফলভাবে পুনরুদ্ধার হয়েছে",
  "task.label.get.all.success": "লেবেলগুলো সফলভাবে পুনরুদ্ধার হয়েছে",
  "task.label.update.success": "লেবেল সফলভাবে হালনাগাদ হয়েছে",
  "task.label.update.many.success": "লেবেলগুলো সফলভাবে হালনাগাদ হয়েছে",
  "task.label.delete.success": "লেবেল সফলভাবে মুছে ফেলা হয়েছে",
  "task.label.restore.success": "লেবেল সফলভাবে পুনরায় সক্রিয় হয়েছে",

  "task.comment.not.found": "মন্তব্য পাওয়া যায়নি",
  "task.comment.create.success": "মন্তব্য সফলভাবে যোগ হয়েছে",
  "task.comment.create.many.success": "মন্তব্যগুলো সফলভাবে যোগ হয়েছে",
  "task.comment.get.success": "মন্তব্য সফলভাবে পুনরুদ্ধার হয়েছে",
  "task.comment.get.all.success": "মন্তব্যগুলো সফলভাবে পুনরুদ্ধার হয়েছে",
  "task.comment.update.success": "মন্তব্য সফলভাবে হালনাগাদ হয়েছে",
  "task.comment.update.many.success": "মন্তব্যগুলো সফলভাবে হালনাগাদ হয়েছে",
  "task.comment.delete.success": "মন্তব্য সফলভাবে মুছে ফেলা হয়েছে",
  "task.comment.restore.success": "মন্তব্য সফলভাবে পুনরায় সক্রিয় হয়েছে",

  "task.manager.boards.title": "টাস্ক বোর্ড",
  "task.manager.boards.subtitle":
    "আপনার প্রকল্প বোর্ডগুলো পরিচালনা ও সংগঠিত করুন",
  "task.manager.board.new": "নতুন বোর্ড",
  "task.manager.board.name.placeholder": "যেমন, প্রোডাক্ট ব্যাকলগ",
  "task.manager.board.description.placeholder": "ঐচ্ছিক বিবরণ",
  "task.manager.board.color.label": "বোর্ডের রঙ",
  "task.manager.board.empty": "এখনো কোনো বোর্ড নেই",
  "task.manager.board.empty.hint": "শুরু করতে প্রথম বোর্ড তৈরি করুন",
  "task.manager.board.members": "সদস্য",
  "task.manager.board.lists": "তালিকা",
  "task.manager.board.tasks": "টাস্ক",
  "task.manager.board.add.list": "তালিকা যোগ করুন",
  "task.manager.board.add.task": "টাস্ক যোগ করুন",
  "task.manager.board.drop.tasks.here": "এখানে টাস্ক ফেলুন",
  "task.manager.board.list.empty":
    'এখনো কোনো তালিকা নেই। "তালিকা যোগ করুন" ক্লিক করুন।',
  "task.manager.list.new": "নতুন তালিকা",
  "task.manager.list.name.label": "তালিকার নাম",
  "task.manager.list.name.placeholder": "যেমন, চলমান",
  "task.manager.list.rename": "তালিকার নাম পরিবর্তন",

  "task.manager.board.manage.members": "সদস্য",
  "task.manager.member.manage.title": "সদস্য পরিচালনা",
  "task.manager.member.add": "সদস্য যোগ করুন",
  "task.manager.member.no.members": "এখনো কোনো সদস্য নেই।",
  "task.manager.member.user.label": "ব্যবহারকারী",
  "task.manager.member.user.placeholder": "নাম বা ইমেইল দিয়ে খুঁজুন",
  "task.manager.member.role.label": "ভূমিকা",
  "task.manager.member.role.placeholder": "ভূমিকা নির্বাচন করুন",
  "task.manager.member.role.owner": "মালিক",
  "task.manager.member.role.admin": "প্রশাসক",
  "task.manager.member.role.member": "সদস্য",
  "task.manager.member.role.viewer": "দর্শক",

  "task.manager.board.manage.labels": "লেবেল",
  "task.manager.label.manage.title": "লেবেল পরিচালনা",
  "task.manager.label.name.label": "লেবেলের নাম",
  "task.manager.label.name.placeholder": "যেমন, বাগ, ফিচার",
  "task.manager.label.color.label": "রঙ",
  "task.manager.label.add": "লেবেল যোগ করুন",
  "task.manager.label.no.labels": "এখনো কোনো লেবেল নেই।",

  "task.manager.board.edit": "বোর্ড সম্পাদনা",
  "task.manager.board.name.label": "বোর্ডের নাম",
  "task.manager.board.description.label": "বিবরণ",

  "task.manager.view.board": "বোর্ড",
  "task.manager.view.list": "তালিকা",

  "task.manager.table.title": "শিরোনাম",
  "task.manager.table.list": "তালিকা",
  "task.manager.table.priority": "অগ্রাধিকার",
  "task.manager.table.assignee": "বরাদ্দকারী",
  "task.manager.table.due.date": "নির্ধারিত তারিখ",
  "task.manager.table.empty": "এখনো কোনো টাস্ক নেই।",

  "task.form.title.create": "নতুন টাস্ক",
  "task.form.title.edit": "টাস্ক সম্পাদনা",
  "task.form.title.label": "শিরোনাম",
  "task.form.title.placeholder": "টাস্কের শিরোনাম",
  "task.form.description.placeholder": "বিবরণ যোগ করুন...",
  "task.form.priority.label": "অগ্রাধিকার",
  "task.form.priority.placeholder": "অগ্রাধিকার নির্বাচন করুন",
  "task.form.due.date.label": "নির্ধারিত তারিখ",
  "task.form.due.date.placeholder": "তারিখ নির্বাচন করুন",
  "task.form.assignee.label": "বরাদ্দকারী",
  "task.form.assignee.placeholder": "বোর্ড সদস্যকে বরাদ্দ করুন",
  "task.form.labels.label": "লেবেল",
  "task.form.labels.placeholder": "লেবেল নির্বাচন করুন",

  "task.priority.LOW": "কম",
  "task.priority.MEDIUM": "মধ্যম",
  "task.priority.HIGH": "উচ্চ",
  "task.priority.URGENT": "জরুরি",

  "task.detail.description.empty": "কোনো বিবরণ নেই",
  "task.detail.comments.label": "মন্তব্য",
  "task.detail.comments.empty": "এখনো কোনো মন্তব্য নেই",
  "task.detail.comment.placeholder": "একটি মন্তব্য যোগ করুন...",
  "task.detail.due.label": "নির্ধারিত",
  "task.detail.assignees.label": "নিয়োজিত",
  "task.detail.edit": "টাস্ক সম্পাদনা করুন",
  "task.detail.delete": "টাস্ক মুছুন",
  "task.comment.reply": "উত্তর দিন",
  "task.comment.reply.placeholder": "একটি উত্তর লিখুন...",
  "task.comment.forbidden": "অন্য ব্যবহারকারীর মন্তব্য সম্পাদনা করা যাবে না",
  ...
  "ai-assistant.chat.success": "চ্যাট উত্তর তৈরি হয়েছে",
  "ai-assistant.pin.not.found": "পিন করা ফলাফল পাওয়া যায়নি",
  "ai-assistant.pin.success": "ফলাফল পিন করা হয়েছে",
  "ai-assistant.sync.success": "পিন সিঙ্ক করা হয়েছে",
  "ai-assistant.sync.unsupported": "এই পিনটি সিঙ্ক সমর্থন করে না",
  "ai-assistant.pinned.get.all.success": "পিন করা ফলাফলগুলো পুনরুদ্ধার হয়েছে",
  "ai-assistant.history.get.all.success": "চ্যাট ইতিহাস পুনরুদ্ধার হয়েছে",
  "ai-assistant.history.forbidden.all":
    "সকল ব্যবহারকারীর চ্যাট ইতিহাস দেখার অনুমতি নেই",
  "ai-assistant.tool.execution.failed": "টুল কার্যকর করতে ব্যর্থ হয়েছে",
  "ai-assistant.widget.title": "সহায়ক",
  "ai-assistant.widget.placeholder": "আমাকে যেকোনো কিছু জিজ্ঞাসা করুন…",
  "ai-assistant.widget.empty": "শুরু করতে আমাকে কিছু জিজ্ঞাসা করুন",
  "ai-assistant.widget.pin": "পিন করুন",
  "ai-assistant.widget.pinned": "পিন করা হয়েছে",
  "ai-assistant.widget.error": "ত্রুটি: {{error}}",
  "ai-assistant.title": "এআই সহায়ক",
  "ai-assistant.subtitle":
    "সহায়কের সাথে চ্যাট করুন এবং আপনার পিন করা ফলাফলগুলো আবার দেখুন",

  "ai-assistant.tabs.chat": "চ্যাট",
  "ai-assistant.tabs.pinned": "পিন করা",
  "ai-assistant.chat.new": "নতুন চ্যাট",
  "ai-assistant.chat.show-all": "সকল ব্যবহারকারীর চ্যাট দেখান",
  "ai-assistant.chat.filter.all": "সকল ব্যবহারকারী",
  "ai-assistant.chat.filter.user": "নির্দিষ্ট ব্যবহারকারী",
  "ai-assistant.chat.filter.anonymous": "অজ্ঞাতনামা",
  "ai-assistant.chat.filter.user-placeholder": "ব্যবহারকারী খুঁজুন...",
  "ai-assistant.chat.anonymous": "অজ্ঞাতনামা",
  "ai-assistant.chat.empty-list": "এখনো কোনো কথোপকথন নেই",
  "ai-assistant.chat.untitled": "নতুন কথোপকথন",
  "ai-assistant.chat.greeting": "আজ আমি আপনাকে কীভাবে সাহায্য করতে পারি?",
  "ai-assistant.chat.greeting-hint":
    "একটি নতুন কথোপকথন শুরু করুন অথবা সাইডবার থেকে একটি বেছে নিন",
  "ai-assistant.chat.readonly-banner":
    "{{user}}-এর কথোপকথন দেখা হচ্ছে (শুধুমাত্র পঠনযোগ্য)",
  "ai-assistant.pinned.empty": "এখনো কোনো পিন করা ফলাফল নেই",
  "ai-assistant.pinned.empty.hint":
    "এখানে দেখতে সহায়কের চ্যাট থেকে একটি উত্তর পিন করুন",
  "ai-assistant.pinned.sync": "সিঙ্ক করুন",
  "ai-assistant.pinned.sync-count": "সিঙ্ক",
  "ai-assistant.pinned.sync-history": "সিঙ্ক ইতিহাস",
  "ai-assistant.pinned.prompt": "জিজ্ঞাসা করা হয়েছে",
  "ai-assistant.pinned.select-hint":
    "দেখতে তালিকা থেকে একটি পিন করা ফলাফল নির্বাচন করুন",
};
...
export const ARABIC_TRANSLATIONS = {
  ...
  "error.conflict": "{{entity}} بهذا {{field}} موجود بالفعل",
  "error.db.foreign.key": "مرجع غير صحيح لـ '{{field}}'",
  "error.db.not.null": "الحقل المطلوب '{{field}}' لا يمكن أن يكون فارغاً",
  "error.db.invalid.input": "قيمة {{type}} غير صالحة",
  "error.db.value.too.long": "القيمة طويلة جداً لـ '{{field}}'",
  "error.db.check.constraint": "{{entity}} ينتهك قاعدة التحقق",
  "error.db.deadlock": "تعذر إتمام الطلب بسبب تعارض، يرجى المحاولة مرة أخرى",
  ...
  "shared.search": "بحث",
  "shared.pagination.report":
    "عرض {first} إلى {last} من أصل {totalRecords} سجل",
  "shared.select": "اختر...",
  ...
  "shared.required": "مطلوب",
  "shared.verified": "مُتحقق",
  "shared.unverified": "غير موثق",
  "shared.view": "عرض",
  ...
  "layout.launcher.no.apps": "لا توجد تطبيقات متاحة",
  ...
  "menu.task.manager": "مدير المهام",
  "menu.ai.assistant": "المساعد الذكي",
  ...
  "form.builder.subtitle": "إنشاء وإدارة نماذجك",
  ...
  "form.builder.tab.fields": "الحقول",
  "form.builder.tab.canvas": "اللوحة",
  "form.builder.tab.properties": "الخصائص",
  "form.builder.details.general.settings": "عام",
  "form.builder.details.access.response.settings": "الوصول والاستجابات",
  ...
  "form.builder.details.tags": "الوسوم",
  "form.builder.details.tags.placeholder": "مثال: استبيان، مراجعة",
  "form.builder.details.tags.hint": "تسميات تساعد في تصنيف وتنظيم هذا النموذج",
  ...
  "form.builder.mobile.tab.fields": "حقول",
  "form.builder.mobile.tab.canvas": "اللوحة",
  "form.builder.mobile.tab.properties": "تعديل",
  ...
  "notification.subtitle": "ابقَ على اطلاع بأحدث نشاطاتك",
  ...
  "task.board.not.found": "اللوحة غير موجودة",
  "task.board.create.success": "تم إنشاء اللوحة بنجاح",
  "task.board.create.many.success": "تم إنشاء اللوحات بنجاح",
  "task.board.get.success": "تم استرداد اللوحة بنجاح",
  "task.board.get.all.success": "تم استرداد اللوحات بنجاح",
  "task.board.update.success": "تم تحديث اللوحة بنجاح",
  "task.board.update.many.success": "تم تحديث اللوحات بنجاح",
  "task.board.delete.success": "تم حذف اللوحة بنجاح",
  "task.board.restore.success": "تمت استعادة اللوحة بنجاح",
  "task.board.member.added": "تمت إضافة العضو إلى اللوحة",
  "task.board.member.removed": "تمت إزالة العضو من اللوحة",
  "task.board.member.not.found": "عضو اللوحة غير موجود",
  "task.board.member.already.exists": "المستخدم عضو في اللوحة بالفعل",
  "task.board.member.get.all.success": "تم استرداد أعضاء اللوحة بنجاح",

  "task.list.not.found": "القائمة غير موجودة",
  "task.list.create.success": "تم إنشاء القائمة بنجاح",
  "task.list.create.many.success": "تم إنشاء القوائم بنجاح",
  "task.list.get.success": "تم استرداد القائمة بنجاح",
  "task.list.get.all.success": "تم استرداد القوائم بنجاح",
  "task.list.update.success": "تم تحديث القائمة بنجاح",
  "task.list.update.many.success": "تم تحديث القوائم بنجاح",
  "task.list.delete.success": "تم حذف القائمة بنجاح",
  "task.list.restore.success": "تمت استعادة القائمة بنجاح",
  "task.list.reorder.success": "تمت إعادة ترتيب القوائم بنجاح",

  "task.not.found": "المهمة غير موجودة",
  "task.create.success": "تم إنشاء المهمة بنجاح",
  "task.create.many.success": "تم إنشاء المهام بنجاح",
  "task.get.success": "تم استرداد المهمة بنجاح",
  "task.get.all.success": "تم استرداد المهام بنجاح",
  "task.update.success": "تم تحديث المهمة بنجاح",
  "task.update.many.success": "تم تحديث المهام بنجاح",
  "task.delete.success": "تم حذف المهمة بنجاح",
  "task.restore.success": "تمت استعادة المهمة بنجاح",
  "task.move.success": "تم نقل المهمة بنجاح",
  "task.assign.success": "تم تعيين المهمة بنجاح",
  "task.assignee.not.board.member": "المكلف ليس عضوًا في اللوحة",

  "task.label.not.found": "التسمية غير موجودة",
  "task.label.create.success": "تم إنشاء التسمية بنجاح",
  "task.label.create.many.success": "تم إنشاء التسميات بنجاح",
  "task.label.get.success": "تم استرداد التسمية بنجاح",
  "task.label.get.all.success": "تم استرداد التسميات بنجاح",
  "task.label.update.success": "تم تحديث التسمية بنجاح",
  "task.label.update.many.success": "تم تحديث التسميات بنجاح",
  "task.label.delete.success": "تم حذف التسمية بنجاح",
  "task.label.restore.success": "تمت استعادة التسمية بنجاح",

  "task.comment.not.found": "التعليق غير موجود",
  "task.comment.create.success": "تمت إضافة التعليق بنجاح",
  "task.comment.create.many.success": "تمت إضافة التعليقات بنجاح",
  "task.comment.get.success": "تم استرداد التعليق بنجاح",
  "task.comment.get.all.success": "تم استرداد التعليقات بنجاح",
  "task.comment.update.success": "تم تحديث التعليق بنجاح",
  "task.comment.update.many.success": "تم تحديث التعليقات بنجاح",
  "task.comment.delete.success": "تم حذف التعليق بنجاح",
  "task.comment.restore.success": "تمت استعادة التعليق بنجاح",

  "task.manager.boards.title": "لوحات المهام",
  "task.manager.boards.subtitle": "إدارة وتنظيم لوحات مشروعك",
  "task.manager.board.new": "لوحة جديدة",
  "task.manager.board.name.placeholder": "مثل، قائمة المنتجات المتراكمة",
  "task.manager.board.description.placeholder": "وصف اختياري",
  "task.manager.board.color.label": "لون اللوحة",
  "task.manager.board.empty": "لا توجد لوحات بعد",
  "task.manager.board.empty.hint": "أنشئ لوحتك الأولى للبدء",
  "task.manager.board.members": "الأعضاء",
  "task.manager.board.lists": "القوائم",
  "task.manager.board.tasks": "المهام",
  "task.manager.board.add.list": "إضافة قائمة",
  "task.manager.board.add.task": "إضافة مهمة",
  "task.manager.board.drop.tasks.here": "أسقط المهام هنا",
  "task.manager.board.list.empty":
    'لا توجد قوائم بعد. انقر على "إضافة قائمة" لإنشاء واحدة.',
  "task.manager.list.new": "قائمة جديدة",
  "task.manager.list.name.label": "اسم القائمة",
  "task.manager.list.name.placeholder": "مثل، قيد التنفيذ",
  "task.manager.list.rename": "إعادة تسمية القائمة",

  "task.manager.board.manage.members": "الأعضاء",
  "task.manager.member.manage.title": "إدارة الأعضاء",
  "task.manager.member.add": "إضافة عضو",
  "task.manager.member.no.members": "لا يوجد أعضاء بعد.",
  "task.manager.member.user.label": "المستخدم",
  "task.manager.member.user.placeholder": "البحث بالاسم أو البريد الإلكتروني",
  "task.manager.member.role.label": "الدور",
  "task.manager.member.role.placeholder": "اختر دورًا",
  "task.manager.member.role.owner": "المالك",
  "task.manager.member.role.admin": "مسؤول",
  "task.manager.member.role.member": "عضو",
  "task.manager.member.role.viewer": "مشاهد",

  "task.manager.board.manage.labels": "التسميات",
  "task.manager.label.manage.title": "إدارة التسميات",
  "task.manager.label.name.label": "اسم التسمية",
  "task.manager.label.name.placeholder": "مثل، خطأ، ميزة",
  "task.manager.label.color.label": "اللون",
  "task.manager.label.add": "إضافة تسمية",
  "task.manager.label.no.labels": "لا توجد تسميات بعد.",

  "task.manager.board.edit": "تعديل اللوحة",
  "task.manager.board.name.label": "اسم اللوحة",
  "task.manager.board.description.label": "الوصف",

  "task.manager.view.board": "لوحة",
  "task.manager.view.list": "قائمة",

  "task.manager.table.title": "العنوان",
  "task.manager.table.list": "القائمة",
  "task.manager.table.priority": "الأولوية",
  "task.manager.table.assignee": "المكلف",
  "task.manager.table.due.date": "تاريخ الاستحقاق",
  "task.manager.table.empty": "لا توجد مهام بعد.",

  "task.form.title.create": "مهمة جديدة",
  "task.form.title.edit": "تعديل المهمة",
  "task.form.title.label": "العنوان",
  "task.form.title.placeholder": "عنوان المهمة",
  "task.form.description.placeholder": "أضف وصفًا...",
  "task.form.priority.label": "الأولوية",
  "task.form.priority.placeholder": "اختر الأولوية",
  "task.form.due.date.label": "تاريخ الاستحقاق",
  "task.form.due.date.placeholder": "اختر تاريخًا",
  "task.form.assignee.label": "المكلف",
  "task.form.assignee.placeholder": "تعيين لعضو في اللوحة",
  "task.form.labels.label": "التسميات",
  "task.form.labels.placeholder": "اختر التسميات",

  "task.priority.LOW": "منخفض",
  "task.priority.MEDIUM": "متوسط",
  "task.priority.HIGH": "عالٍ",
  "task.priority.URGENT": "عاجل",

  "task.detail.description.empty": "لا يوجد وصف",
  "task.detail.comments.label": "التعليقات",
  "task.detail.comments.empty": "لا توجد تعليقات بعد",
  "task.detail.comment.placeholder": "أضف تعليقًا...",
  "task.detail.due.label": "الاستحقاق",
  "task.detail.assignees.label": "المكلفون",
  "task.detail.edit": "تعديل المهمة",
  "task.detail.delete": "حذف المهمة",
  "task.comment.reply": "رد",
  "task.comment.reply.placeholder": "اكتب ردًا...",
  "task.comment.forbidden": "لا يمكن تعديل تعليق مستخدم آخر",

  "ai-assistant.chat.success": "تم إنشاء رد الدردشة",
  "ai-assistant.pin.not.found": "لم يتم العثور على النتيجة المثبتة",
  "ai-assistant.pin.success": "تم تثبيت النتيجة",
  "ai-assistant.sync.success": "تمت مزامنة التثبيت",
  "ai-assistant.sync.unsupported": "هذا التثبيت لا يدعم المزامنة",
  "ai-assistant.pinned.get.all.success": "تم استرداد النتائج المثبتة",
  "ai-assistant.history.get.all.success": "تم استرداد سجل الدردشة",
  "ai-assistant.history.forbidden.all":
    "غير مسموح لك بعرض سجل دردشة جميع المستخدمين",
  "ai-assistant.tool.execution.failed": "فشل تنفيذ الأداة",
  "ai-assistant.widget.title": "المساعد",
  "ai-assistant.widget.placeholder": "اسألني عن أي شيء…",
  "ai-assistant.widget.empty": "اسألني أي شيء للبدء",
  "ai-assistant.widget.pin": "تثبيت",
  "ai-assistant.widget.pinned": "مثبّت",
  "ai-assistant.widget.error": "خطأ: {{error}}",
  "ai-assistant.title": "المساعد الذكي",
  "ai-assistant.subtitle": "تحدث مع المساعد وراجع نتائجك المثبتة",

  "ai-assistant.tabs.chat": "الدردشة",
  "ai-assistant.tabs.pinned": "المثبتات",
  "ai-assistant.chat.new": "دردشة جديدة",
  "ai-assistant.chat.show-all": "إظهار دردشات جميع المستخدمين",
  "ai-assistant.chat.filter.all": "جميع المستخدمين",
  "ai-assistant.chat.filter.user": "مستخدم محدد",
  "ai-assistant.chat.filter.anonymous": "مجهول",
  "ai-assistant.chat.filter.user-placeholder": "ابحث عن المستخدمين...",
  "ai-assistant.chat.anonymous": "مجهول",
  "ai-assistant.chat.empty-list": "لا توجد محادثات بعد",
  "ai-assistant.chat.untitled": "محادثة جديدة",
  "ai-assistant.chat.greeting": "كيف يمكنني مساعدتك اليوم؟",
  "ai-assistant.chat.greeting-hint":
    "ابدأ محادثة جديدة أو اختر واحدة من الشريط الجانبي",
  "ai-assistant.chat.readonly-banner": "عرض محادثة {{user}} (للقراءة فقط)",
  "ai-assistant.pinned.empty": "لا توجد نتائج مثبتة بعد",
  "ai-assistant.pinned.empty.hint": "ثبّت ردًا من دردشة المساعد لرؤيته هنا",
  "ai-assistant.pinned.sync": "مزامنة",
  "ai-assistant.pinned.sync-count": "مزامنات",
  "ai-assistant.pinned.sync-history": "سجل المزامنة",
  "ai-assistant.pinned.prompt": "تم السؤال",
  "ai-assistant.pinned.select-hint": "اختر نتيجة مثبتة من القائمة لعرضها",
};
