...
const SHARED_MESSAGES: Record<string, string> = {
  ...
  'shared.pagination.report': 'Showing {first} to {last} of {totalRecords} records',
...
const AUTH_MESSAGES: Record<string, string> = {
  ...
  'auth.login.requires.selection': 'Please select a company and branch to continue',
  ...
  'auth.company.feature.not.enabled': 'This feature is not enabled for your company',
  ...
  'auth.password.reset.token.used': 'Password reset token has already been used',
  ...
  'auth.login.select.company.message': 'Please select a company and branch to continue',
  ...
  'auth.validation.password.min.length': 'Password must be at least 8 characters',
  ...
  'auth.validation.password.require.number': 'Password must contain at least one number',
  ...
  'auth.forgot.password.subtitle': 'Enter your email address and we will send you a reset link.',
  ...
  'auth.forgot.password.email.sent.to': 'We sent a password reset link to {{email}}',
  ...
  'auth.verify.email.please.wait': 'Please wait while we verify your email address...',
  ...
  'auth.verify.email.invalid.link': 'This verification link is invalid or has expired.',
  'auth.verify.email.resend.email': 'Resend Verification Email',
  'auth.verify.email.resend.title': 'Resend Verification',
  'auth.verify.email.resend.subtitle': 'Enter your email to receive a new verification link.',
  ...
  'auth.reset.password.confirm.password.placeholder': 'Confirm your new password',
  ...
  'auth.reset.password.invalid.link.message': 'This password reset link is invalid or has expired.',
...
const ADMINISTRATIVE_MESSAGES: Record<string, string> = {
  ...
  'user.profile.section.data.success': 'Profile section data retrieved successfully',
  'user.profile.section.update.success': 'Profile section updated successfully',
  'user.profile.completion.success': 'Profile completion retrieved successfully',
  ...
  'user.permission.company.list.success': 'User companies retrieved successfully',
  'user.permission.branch.list.success': 'User branches retrieved successfully',
  'user.permission.batch.success': 'Processed {{added}} additions and {{removed}} removals',
  ...
  'administrative.permission.no.company': 'This user has no company permissions assigned.',
  ...
  'administrative.user.auto.assign.to': 'New user will be automatically assigned to',
...
const IAM_MESSAGES: Record<string, string> = {
  ...
  'iam.permission.subtitle': 'Assign and manage access across roles, users, and companies',
  ...
  'iam.permission.empty.company.actions.title': 'Select a company to get started',
...
const STORAGE_MESSAGES: Record<string, string> = {
  ...
  'storage.config.create.many.success': '{{count}} storage configurations created successfully',
  'storage.config.get.success': 'Storage configuration retrieved successfully',
  'storage.config.get.by.ids.success': 'Storage configurations retrieved successfully by Ids',
  'storage.config.get.by.filter.success': 'Storage configurations retrieved successfully by filter',
  'storage.config.get.all.success': 'Storage configurations retrieved successfully',
  'storage.config.update.success': 'Storage configuration updated successfully',
  'storage.config.update.many.success': '{{count}} storage configurations updated successfully',
  'storage.config.delete.success': 'Storage configuration deleted successfully',
  'storage.config.restore.success': 'Storage configuration restored successfully',

  // Upload (API keys)
  'upload.success': 'File uploaded successfully',
  'upload.many.success': 'Files uploaded successfully',
  'upload.file.too.large': 'File size ({{fileSize}}MB) exceeds maximum {{maxSize}}MB',
  'upload.invalid.type': 'File type "{{mimeType}}" not allowed. Allowed: {{allowedTypes}}',
  ...
  'storage.empty.configs.in.company': 'No storage configurations found in current company',
  ...
  'storage.delete.move.to.trash.confirm': 'Move "{{name}}" to trash? You can recover it later.',
  ...
  'storage.config.no.configs': 'No storage configurations found. Please create one first.',
...
const FORM_BUILDER_MESSAGES: Record<string, string> = {
  ...
  'form.permission.check.failed': 'Unable to verify permissions. Please try again.',
  ...
  'form.result.create.many.success': '{{count}} form results created successfully',
  'form.result.get.success': 'Form result retrieved successfully',
  'form.result.get.by.ids.success': 'Form results retrieved successfully by Ids',
  'form.result.get.by.filter.success': 'Form results retrieved successfully by filter',
  ...
  'form.result.update.many.success': '{{count}} form results updated successfully',
  ...
  'form.builder.details.tags.hint': 'Labels to help categorize and organize this form',
  ...
  'form.builder.details.users.with.access': 'Users with these actions will have access',
  ...
  'form.builder.details.permissions.placeholder': 'Type permission code and press Enter',
  ...
  'form.builder.details.response.mode.multiple.hint': 'Users can submit unlimited responses.',
  'form.builder.details.form.is.active': 'Form is Active',
  'form.builder.details.add.fields.to.preview': 'Add fields in the Builder tab to see preview',
  ...
  'form.builder.public.login.required': 'This form requires you to be logged in.',
  ...
  'form.builder.public.response.recorded.success': 'Your response has been recorded successfully.',
  ...
  'form.builder.public.single.submission.note': 'This form only allows one submission per user.',
  'form.builder.error.form.id.required': 'Form ID is required',
  'form.builder.error.form.not.available': 'This form does not exist or is not available.',
  ...
  'form.builder.error.not.public': 'This form is not available for public access.',
  ...
  'form.builder.toast.draft.saved.detail': 'Your progress has been saved locally',
  ...
  'form.builder.tooltip.toggle.layout': 'Toggle between section-based and flat form layout',
  ...
  'form.builder.layout.grid.columns.hint': 'Number of columns in the grid layout for this section.',
  ...
  'form.builder.email.pattern.hint': 'Regular expression to restrict accepted email domains.',
  ...
  'form.builder.email.pattern.message.placeholder': 'e.g., Only company emails are accepted',
  'form.builder.email.pattern.message.hint': 'Shown when the email does not match the pattern.',
  ...
  'form.builder.validation.unlimited.hint': 'Leave empty for unlimited selections.',
  'form.builder.validation.max.files': 'Max Files',
  'form.builder.validation.max.file.size': 'Max File Size (bytes)',
  'form.builder.validation.no.options': 'No options added. Add at least one option.',
  ...
  'form.builder.logic.of.following.conditions': 'of the following conditions are true',
  ...
  'form.builder.computed.click.to.create': 'Click "Add Computed Field" to create one',
  ...
  'form.builder.computed.default.value.label': 'Default Value (if no rules match)',
  ...
  'form.builder.computed.no.condition.always': 'No condition = always applies (if reached)',
  ...
  'form.builder.logic.action.make.field.required.when': 'Make field required when...',
  ...
  'form.builder.logic.action.hide.this.section.when': 'Hide this section when...',
  'form.builder.logic.action.show.this.section.when': 'Show this section when...',
  ...
  'form.builder.tooltip.conditional.visibility': 'Conditional visibility rules active',
  ...
  'form.builder.layout.responsive.hint': 'Automatically adjust columns based on screen size.',
  ...
  'form.builder.layout.click.form.fields': 'Click "Form Fields" to edit layout settings',
  'form.builder.layout.select.field.to.edit': 'or select a field to edit its properties',
  'form.builder.layout.select.to.edit': 'Select a field or section to edit its properties',
  ...
  'form.builder.result.fields.answered': '{{answered}} / {{total}} fields answered',
  'form.builder.result.computed.title': 'Computed Results',
  'form.builder.result.computed.subtitle': 'Auto-calculated based on your responses',
  ...
  'form.builder.validation.other.required': 'Please specify a value for {{label}}',
  'form.builder.validation.email': 'Please enter a valid email address',
  'form.builder.validation.must.match.format': '{{label}} must match the required format',
  'form.builder.validation.min.length': '{{label}} must be at least {{value}} characters',
  'form.builder.validation.max.length': '{{label}} must be at most {{value}} characters',
  ...
  'form.builder.schema.browser.only': 'This feature is only available in browser',
  ...
  'form.builder.validation.schema.name.required': 'Schema must have a string name',
  'form.builder.validation.schema.sections.required': 'Schema must have a sections array',
  'form.builder.validation.section.must.be.object': 'Section must be an object',
  'form.builder.validation.section.id.required': 'Section must have a string id',
  'form.builder.validation.section.name.required': 'Section must have a string name',
  'form.builder.validation.section.fields.required': 'Section must have a fields array',
  ...
  'form.builder.validation.field.label.required': 'Field must have a string label',
  'form.builder.validation.field.options.required': 'Selection field must have an options array',
...
const EVENT_MANAGER_MESSAGES: Record<string, string> = {
  ...
  'event.participant.status.update.success': 'Participant status updated successfully',
  ...
  'event.manager.placeholder.meeting.link': 'https://meet.google.com/... (optional)',
...
const NOTIFICATION_MESSAGES = {
  ...
  'notification.create.many.success': '{{count}} notifications created successfully',
  'notification.get.success': 'Notification retrieved successfully',
  'notification.get.by.ids.success': 'Notifications retrieved successfully by Ids',
  'notification.get.by.filter.success': 'Notifications retrieved successfully by filter',
  ...
  'notification.update.many.success': '{{count}} notifications updated successfully',
  ...
  'notification.mark.all.read.success': '{{count}} notifications marked as read',
...
const LOCALIZATION_MESSAGES: Record<string, string> = {
  ...
  'language.get.by.filter.success': 'Languages retrieved successfully by filter',
  ...
  'translation.key.create.many.success': '{{count}} translation keys created successfully',
  'translation.key.get.success': 'Translation key retrieved successfully',
  'translation.key.get.by.ids.success': 'Translation keys retrieved successfully by Ids',
  'translation.key.get.by.filter.success': 'Translation keys retrieved successfully by filter',
  ...
  'translation.key.update.many.success': '{{count}} translation keys updated successfully',
  ...
  'translation.key.readonly.delete.forbidden': 'Cannot delete readonly translation keys: {{keys}}',
  ...
  'translation.create.many.success': '{{count}} translations created successfully',
  'translation.get.success': 'Translation retrieved successfully',
  'translation.get.by.ids.success': 'Translations retrieved successfully by Ids',
  'translation.get.by.filter.success': 'Translations retrieved successfully by filter',
  ...
  'translation.update.many.success': '{{count}} translations updated successfully',
  ...
  'localization.language.subtitle': 'Manage available languages for your application',
  ...
  'localization.language.empty': 'No languages configured. Add a language to get started.',
  'localization.language.confirm.set.default': 'Set "{{name}}" as the default language?',
  ...
  'localization.language.iso.code.hint': 'ISO 639-1 language code (e.g., en, ar, fr)',
  ...
  'localization.validation.code.max.length': 'Language code must be at most 10 characters',
  'localization.validation.name.required': 'Language name is required',
  'localization.validation.name.max.length': 'Language name must be at most 100 characters',
  ...
  'localization.placeholder.key.description': 'Optional description for translators',
  'localization.key.variables': 'Variables',
  'localization.key.variables.placeholder': 'e.g., name, count, date',
  'localization.key.variables.hint': 'Enter variable names used in this translation',
  ...
  'localization.validation.default.message.required': 'Default message is required',
};
...
const TASK_MANAGER_MESSAGES: Record<string, string> = {
  ...
  'task.manager.board.list.empty': 'No lists yet. Click "Add List" to create one.',
...
const AI_ASSISTANT_MESSAGES: Record<string, string> = {
  ...
  'ai-assistant.history.forbidden.all': 'Not permitted to view all users chat history',
  ...
  'ai-assistant.subtitle': 'Chat with the assistant and revisit your pinned results',
  ...
  'ai-assistant.chat.greeting-hint': 'Start a new conversation or pick one from the sidebar',
  'ai-assistant.chat.readonly-banner': "Viewing {{user}}'s conversation (read-only)",

  'ai-assistant.pinned.empty': 'No pinned results yet',
  'ai-assistant.pinned.empty.hint': 'Pin a reply from the assistant chat to see it here',
  ...
  'ai-assistant.pinned.select-hint': 'Select a pinned result from the list to view it',
};
...
const MODULE_CONFIGS: ModuleConfig[] = [
  ...
  { name: 'administrative', messages: ADMINISTRATIVE_MESSAGES, readOnly: true, enabled: true },
  { name: 'profile', messages: PROFILE_MESSAGES, readOnly: true, enabled: true },
  { name: 'iam', messages: IAM_MESSAGES, readOnly: true, enabled: true },
  { name: 'layout', messages: LAYOUT_MESSAGES, readOnly: true, enabled: true },
  { name: 'storage', messages: STORAGE_MESSAGES, readOnly: true, enabled: true },
...
export const BENGALI_TRANSLATIONS = {
  ...
  'error.db.deadlock': 'দ্বন্দ্বের কারণে অনুরোধটি সম্পন্ন করা যায়নি, অনুগ্রহ করে আবার চেষ্টা করুন',
  ...
  'error.insufficient.permissions': 'প্রয়োজনীয় অনুমতি অনুপস্থিত: {{permissions}}',
  ...
  'system.service.not.available': 'সেবা "{{provider}}" উপলব্ধ নয়। উপলব্ধ: {{available}}',
  ...
  'shared.fill.required.fields': 'অনুগ্রহ করে সমস্ত প্রয়োজনীয় ফিল্ড পূরণ করুন',

  'shared.file.selector.provider.not.configured': 'ফাইল নির্বাচন কনফিগার করা নেই।',
  ...
  'shared.upload.drop.multiple': 'ফাইলগুলো এখানে ড্রপ করুন অথবা আপলোড করতে ক্লিক করুন',
  'shared.upload.drop.single': 'ফাইলটি এখানে ড্রপ করুন অথবা আপলোড করতে ক্লিক করুন',
  ...
  'shared.pagination.report': '{first} থেকে {last} পর্যন্ত দেখানো হচ্ছে, মোট {totalRecords}',
  ...
  'layout.company.branch.selector.please.select.branch': 'অনুগ্রহ করে একটি শাখা নির্বাচন করুন',
  ...
  'layout.configurator.layout.theme': 'লেআউট',
  'layout.configurator.layout.theme.classic': 'ক্লাসিক',
  'layout.configurator.layout.theme.modern': 'মডার্ন',
  ...
  'menu.components': 'কম্পোনেন্ট',
  'menu.components.display': 'ডিসপ্লে',
  'menu.components.menu': 'মেনু',
  'menu.components.form': 'ফর্ম',
  'menu.components.overlay': 'ওভারলে',
  'menu.components.data': 'ডেটা',
  'menu.components.panel': 'প্যানেল',
  'menu.components.media': 'মিডিয়া',
  'menu.components.misc': 'ডাইরেক্টিভ',
  ...
  'auth.login.requires.selection': 'চালিয়ে যেতে অনুগ্রহ করে একটি কোম্পানি ও শাখা নির্বাচন করুন',
  'auth.login.invalid.credentials': 'অবৈধ ইমেইল বা পাসওয়ার্ড',
  'auth.login.email.not.verified': 'লগইন করার আগে অনুগ্রহ করে আপনার ইমেইল যাচাই করুন',
  ...
  'auth.company.list.success': 'ব্যবহারকারীর কোম্পানিগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'auth.company.not.found': 'কোম্পানি পাওয়া যায়নি',
  'auth.company.required': 'কোম্পানি প্রয়োজন',
  'auth.company.feature.not.enabled': 'এই বৈশিষ্ট্যটি আপনার কোম্পানির জন্য সক্রিয় নয়',
  ...
  'auth.password.reset.token.expired': 'পাসওয়ার্ড রিসেট টোকেনের মেয়াদ শেষ হয়েছে',
  'auth.password.reset.token.used': 'পাসওয়ার্ড রিসেট টোকেন ইতিমধ্যে ব্যবহৃত হয়েছে',
  ...
  'email.verification.resend.success': 'যাচাইকরণ ইমেইল সফলভাবে পুনঃপ্রেরণ করা হয়েছে',
  ...
  'auth.login.sign.in.to.continue': 'আপনার অ্যাকাউন্টে চালিয়ে যেতে সাইন ইন করুন',
  ...
  'auth.validation.password.max.length': 'পাসওয়ার্ড সর্বোচ্চ দৈর্ঘ্য অতিক্রম করেছে',
  'auth.validation.password.pattern': 'পাসওয়ার্ড প্রয়োজনীয়তা পূরণ করে না',
  'auth.validation.password.require.uppercase': 'পাসওয়ার্ডে কমপক্ষে একটি বড় অক্ষর থাকতে হবে',
  'auth.validation.password.require.lowercase': 'পাসওয়ার্ডে কমপক্ষে একটি ছোট অক্ষর থাকতে হবে',
  'auth.validation.password.require.number': 'পাসওয়ার্ডে কমপক্ষে একটি সংখ্যা থাকতে হবে',
  'auth.validation.password.require.special': 'পাসওয়ার্ডে কমপক্ষে একটি বিশেষ অক্ষর থাকতে হবে',
  ...
  'auth.session.expired': 'আপনার সেশনের মেয়াদ শেষ হয়েছে। অনুগ্রহ করে আবার লগইন করুন।',
  ...
  'auth.forgot.password.email.sent.to': 'আমরা {{email}} এ একটি পাসওয়ার্ড রিসেট লিঙ্ক পাঠিয়েছি',
  ...
  'auth.validation.confirm.password.required': 'অনুগ্রহ করে আপনার পাসওয়ার্ড নিশ্চিত করুন',
  ...
  'auth.verify.email.invalid.link': 'এই যাচাইকরণ লিঙ্কটি অবৈধ বা মেয়াদ শেষ হয়ে গেছে।',
  'auth.verify.email.resend.email': 'যাচাইকরণ ইমেইল পুনঃপ্রেরণ',
  'auth.verify.email.resend.title': 'যাচাইকরণ পুনঃপ্রেরণ',
  'auth.verify.email.resend.subtitle': 'নতুন যাচাইকরণ লিঙ্ক পেতে আপনার ইমেইল লিখুন।',
  'auth.verify.email.resend': 'ইমেইল পুনঃপ্রেরণ',
  'auth.verify.email.sent': 'যাচাইকরণ ইমেইল পাঠানো হয়েছে। অনুগ্রহ করে আপনার ইনবক্স চেক করুন।',
  ...
  'auth.reset.password.confirm.password.placeholder': 'আপনার নতুন পাসওয়ার্ড নিশ্চিত করুন',
  ...
  'user.get.by.ids.success': 'আইডি অনুসারে ব্যবহারকারীরা সফলভাবে পুনরুদ্ধার হয়েছে',
  'user.update.success': 'ব্যবহারকারী সফলভাবে হালনাগাদ হয়েছে',
  'user.update.many.success': '{{count}} জন ব্যবহারকারী সফলভাবে হালনাগাদ হয়েছে',
  'user.get.by.filter.success': 'ফিল্টার অনুসারে ব্যবহারকারীরা সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'user.profile.sections.success': 'প্রোফাইল বিভাগসমূহ সফলভাবে পুনরুদ্ধার হয়েছে',
  'user.profile.section.data.success': 'প্রোফাইল বিভাগের তথ্য সফলভাবে পুনরুদ্ধার হয়েছে',
  'user.profile.section.update.success': 'প্রোফাইল বিভাগ সফলভাবে হালনাগাদ হয়েছে',
  'user.profile.completion.success': 'প্রোফাইল সম্পূর্ণতা সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'company.get.by.ids.success': 'আইডি অনুসারে কোম্পানিগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'company.get.by.filter.success': 'ফিল্টার অনুসারে কোম্পানিগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'branch.get.by.ids.success': 'আইডি অনুসারে শাখাগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'branch.get.by.filter.success': 'ফিল্টার অনুসারে শাখাগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'user.permission.company.list.success': 'ব্যবহারকারীর কোম্পানিগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'user.permission.branch.list.success': 'ব্যবহারকারীর শাখাগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'user.permission.batch.success':
    '{{added}}টি সংযোজন এবং {{removed}}টি অপসারণ প্রক্রিয়া করা হয়েছে',
  'user.permission.already.assigned': 'ব্যবহারকারী ইতিমধ্যে এই {{type}}-এ অর্পিত',
  ...
  'administrative.permission.no.company': 'এই ব্যবহারকারীর কোনো কোম্পানির অনুমতি অর্পিত নেই।',
  'administrative.permission.assign.company.first':
  ...
  'administrative.branch.select.company.first': 'অনুগ্রহ করে প্রথমে একটি কোম্পানি নির্বাচন করুন',
  ...
  'administrative.user.auto.assign.to': 'নতুন ব্যবহারকারী স্বয়ংক্রিয়ভাবে অর্পিত হবে',
  ...
  'profile.storage.not.enabled': 'প্রোফাইল ছবি আপলোড উপলব্ধ নয়। স্টোরেজ সেবা কনফিগার করা নেই।',
  ...
  'action.get.by.ids.success': 'আইডি অনুসারে অ্যাকশনগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'action.get.by.filter.success': 'ফিল্টার অনুসারে অ্যাকশনগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'role.get.by.ids.success': 'আইডি অনুসারে ভূমিকাগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'role.get.by.filter.success': 'ফিল্টার অনুসারে ভূমিকাগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'role.permission.actions.success': 'ভূমিকার অ্যাকশনগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'role.permission.user.roles.success': 'ব্যবহারকারীর ভূমিকাগুলো সফলভাবে পুনরুদ্ধার হয়েছে',

  'user.action.permission.get.success': 'ব্যবহারকারীর অ্যাকশন অনুমতিগুলো সফলভাবে পুনরুদ্ধার হয়েছে',

  'company.action.permission.get.success': 'কোম্পানির অ্যাকশন অনুমতিগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'iam.direct.mode.unavailable': 'RBAC-শুধু মোডে সরাসরি অনুমতি অর্পণ উপলব্ধ নয়',
  'iam.rbac.mode.unavailable': 'সরাসরি-শুধু মোডে ভূমিকা-ভিত্তিক অনুমতি অর্পণ উপলব্ধ নয়',
  ...
  'iam.permission.subtitle': 'ভূমিকা, ব্যবহারকারী এবং কোম্পানি জুড়ে অ্যাক্সেস অর্পণ ও পরিচালনা করুন',
  ...
  'iam.permission.select.role.placeholder': 'একটি ভূমিকা অনুসন্ধান করুন এবং নির্বাচন করুন',
  ...
  'iam.permission.no.actions.for.role': 'এই ভূমিকার জন্য কোনো অ্যাকশন উপলব্ধ নেই',
  'iam.tooltip.remove.action': 'সরাতে ক্লিক করুন',
  'iam.tooltip.add.action': 'যোগ করতে ক্লিক করুন (প্রয়োজনীয় স্বয়ংক্রিয়-নির্বাচন)',
  ...
  'iam.permission.select.user.placeholder': 'একটি ব্যবহারকারী অনুসন্ধান করুন এবং নির্বাচন করুন',
  'iam.permission.select.branch': 'শাখা নির্বাচন করুন',
  'iam.permission.select.branch.placeholder': 'একটি শাখা অনুসন্ধান করুন এবং নির্বাচন করুন',
  'iam.branch.permitted.count.plural': 'বর্তমান কোম্পানিতে {{count}}টি অনুমোদিত শাখা',
  ...
  'iam.permission.no.actions.for.user': 'এই ব্যবহারকারীর জন্য কোনো অ্যাকশন উপলব্ধ নেই',
  ...
  'iam.permission.company.required': 'অনুগ্রহ করে প্রথমে একটি কোম্পানি নির্বাচন করুন',
  ...
  'iam.permission.select.company.placeholder': 'একটি কোম্পানি অনুসন্ধান করুন এবং নির্বাচন করুন',
  'iam.permission.action.whitelist': 'অ্যাকশন হোয়াইটলিস্ট',
  'iam.permission.no.actions.for.company': 'এই কোম্পানির জন্য কোনো অ্যাকশন উপলব্ধ নেই',
  ...
  'iam.permission.prerequisite.error.message': 'নিম্নলিখিত অ্যাকশনগুলোর অপূর্ণ পূর্বশর্ত রয়েছে:',
  ...
  'iam.permission.selection.reverted': 'নির্বাচন প্রাথমিক অবস্থায় ফেরানো হয়েছে।',
  ...
  'iam.permission.no.roles.for.user': 'এই ব্যবহারকারীর জন্য কোনো ভূমিকা উপলব্ধ নেই',
  'iam.tooltip.click.to.remove.role.from.user': 'ভূমিকা সরাতে ক্লিক করুন',
  'iam.tooltip.click.to.assign.role.to.user': 'ব্যবহারকারীতে ভূমিকা অর্পণ করতে ক্লিক করুন',
  ...
  'iam.logic.validation.failed.message': 'নিম্নলিখিত অ্যাকশনগুলোর অপূর্ণ পূর্বশর্ত রয়েছে:',
  ...
  'iam.logic.prerequisites.required': 'পূর্বশর্ত প্রয়োজন ({{count}}টি অনুপস্থিত)',
  'iam.logic.click.to.auto.select': 'প্রয়োজনীয় অ্যাকশন স্বয়ংক্রিয়-নির্বাচন করতে ক্লিক করুন',
  'iam.logic.select.action.label': 'অ্যাকশন নির্বাচন করুন',
  'iam.logic.auto.select.actions': 'স্বয়ংক্রিয়-নির্বাচন অ্যাকশন',
  'iam.logic.action.selected.detail': 'অ্যাকশন সফলভাবে নির্বাচিত (পূর্বশর্ত ইতিমধ্যে পূরণ)',
  'iam.logic.auto.selected.detail': 'পূর্বশর্ত সহ {{count}}টি অ্যাকশন স্বয়ংক্রিয়ভাবে নির্বাচিত',
  'iam.logic.minimum.required': ' (ন্যূনতম প্রয়োজন)',
  'iam.logic.auto.select.prompt': 'স্বয়ংক্রিয়-নির্বাচন {{count}}টি অ্যাকশন{{suffix}} বেছে নেবে।',
  ...
  'iam.logic.switch.to.alternatives': 'আপনি কি স্বয়ংক্রিয়ভাবে বিকল্পে স্যুইচ করতে চান?',
  ...
  'iam.logic.switched.to.alternatives': 'স্বয়ংক্রিয়ভাবে বিকল্প অ্যাকশনে স্যুইচ হয়েছে',
  'iam.logic.actions.removed': 'অ্যাকশন সরানো হয়েছে',
  'iam.logic.removed.with.dependents': '{{name}} এবং {{count}}টি নির্ভরশীল অ্যাকশন সরানো হয়েছে',
  ...
  'file.get.by.filter.success': 'ফিল্টার অনুসারে ফাইলগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'folder.get.by.ids.success': 'আইডি অনুসারে ফোল্ডারগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'folder.get.by.filter.success': 'ফিল্টার অনুসারে ফোল্ডারগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'storage.config.create.many.success': '{{count}}টি স্টোরেজ কনফিগারেশন সফলভাবে তৈরি হয়েছে',
  ...
  'storage.config.get.all.success': 'স্টোরেজ কনফিগারেশনগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'storage.config.update.success': 'স্টোরেজ কনফিগারেশন সফলভাবে হালনাগাদ হয়েছে',
  'storage.config.update.many.success': '{{count}}টি স্টোরেজ কনফিগারেশন সফলভাবে হালনাগাদ হয়েছে',
  'storage.config.delete.success': 'স্টোরেজ কনফিগারেশন সফলভাবে মুছে ফেলা হয়েছে',
  'storage.config.restore.success': 'স্টোরেজ কনফিগারেশন সফলভাবে পুনরুদ্ধার হয়েছে',

  'upload.success': 'ফাইল সফলভাবে আপলোড হয়েছে',
  'upload.many.success': 'ফাইলগুলো সফলভাবে আপলোড হয়েছে',
  'upload.file.too.large': 'ফাইলের আকার ({{fileSize}}MB) সর্বোচ্চ {{maxSize}}MB অতিক্রম করেছে',
  'upload.invalid.type': 'ফাইল টাইপ "{{mimeType}}" অনুমোদিত নয়। অনুমোদিত: {{allowedTypes}}',
  ...
  'storage.empty.configs.in.company': 'বর্তমান কোম্পানিতে কোনো স্টোরেজ কনফিগারেশন পাওয়া যায়নি',
  ...
  'storage.empty.files.in.company': 'বর্তমান কোম্পানিতে কোনো ফাইল পাওয়া যায়নি',
  ...
  'storage.folder.no.folders.available': 'কোনো ফোল্ডার উপলব্ধ নেই। ফাইল রুট স্তরে আপলোড হবে।',
  ...
  'storage.upload.drag.drop': 'এখানে ফাইল টেনে ছাড়ুন বা ব্রাউজ করতে ক্লিক করুন',
  'storage.upload.max.size': 'সর্বোচ্চ ফাইল আকার: {{size}}',
  'storage.upload.please.select': 'অনুগ্রহ করে আপলোড করতে একটি ফাইল নির্বাচন করুন',
  ...
  'storage.file.private.hint': 'শুধু অনুমতিপ্রাপ্ত ব্যবহারকারীরাই অ্যাক্সেস করতে পারবেন',
  ...
  'storage.error.no.config': 'অনুগ্রহ করে একটি স্টোরেজ কনফিগারেশন নির্বাচন করুন',
  'storage.upload.failed': 'ফাইল আপলোড করতে ব্যর্থ',

  'storage.button.new.folder': 'নতুন ফোল্ডার',
  'storage.table.slug': 'স্লাগ',
  'storage.empty.folders.in.company': 'বর্তমান কোম্পানিতে কোনো ফোল্ডার পাওয়া যায়নি',
  ...
  'email.config.create.many.success': '{{count}}টি ইমেইল কনফিগারেশন সফলভাবে তৈরি হয়েছে',
  'email.config.get.success': 'ইমেইল কনফিগারেশন সফলভাবে পুনরুদ্ধার হয়েছে',
  'email.config.get.all.success': 'ইমেইল কনফিগারেশনগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'email.config.get.by.ids.success': 'আইডি অনুসারে ইমেইল কনফিগারেশনগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'email.config.update.many.success': '{{count}}টি ইমেইল কনফিগারেশন সফলভাবে হালনাগাদ হয়েছে',
  ...
  'email.template.get.by.ids.success': 'আইডি অনুসারে ইমেইল টেমপ্লেটগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'email.template.get.by.filter.success':
    'ফিল্টার অনুসারে ইমেইল টেমপ্লেটগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'email.template.get.all.success': 'ইমেইল টেমপ্লেটগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'email.template.create.many.success': '{{count}}টি ইমেইল টেমপ্লেট সফলভাবে তৈরি হয়েছে',
  'email.template.update.many.success': '{{count}}টি ইমেইল টেমপ্লেট সফলভাবে হালনাগাদ হয়েছে',
  ...
  'email.send.config.default.not.found': 'ডিফল্ট ইমেইল কনফিগারেশন পাওয়া যায়নি',
  ...
  'email.recipient.example': 'recipient@example.com',
  'email.config.test.dialog.hint': 'কনফিগারেশন যাচাই করতে একটি পরীক্ষা ইমেইল পাঠানো হবে',
  'email.config.send.test': 'পরীক্ষা পাঠান',
  'email.config.enter.recipient': 'অনুগ্রহ করে একটি প্রাপকের ইমেইল ঠিকানা লিখুন',
  ...
  'email.template.variable.hint': 'গতিশীল কন্টেন্টের জন্য {{variableName}} ব্যবহার করুন',
  ...
  'form.get.by.filter.success': 'ফিল্টার অনুসারে ফর্মগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'form.permission.check.failed': 'অনুমতি যাচাই করা যাচ্ছে না। অনুগ্রহ করে আবার চেষ্টা করুন।',
  'form.get.access.info.success': 'ফর্ম অ্যাক্সেস তথ্য সফলভাবে পুনরুদ্ধার হয়েছে',

  'form.result.create.success': 'ফর্ম ফলাফল সফলভাবে তৈরি হয়েছে',
  'form.result.create.many.success': '{{count}}টি ফর্ম ফলাফল সফলভাবে তৈরি হয়েছে',
  'form.result.get.success': 'ফর্ম ফলাফল সফলভাবে পুনরুদ্ধার হয়েছে',
  'form.result.get.by.ids.success': 'আইডি অনুসারে ফর্ম ফলাফলগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'form.result.get.by.filter.success': 'ফিল্টার অনুসারে ফর্ম ফলাফলগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'form.result.update.many.success': '{{count}}টি ফর্ম ফলাফল সফলভাবে হালনাগাদ হয়েছে',
  ...
  'form.builder.details.used.for.public.urls': 'পাবলিক ফর্ম URL এর জন্য ব্যবহৃত',
  'form.builder.details.tags': 'ট্যাগ',
  'form.builder.details.tags.placeholder': 'যেমন, জরিপ, পর্যালোচনা',
  'form.builder.details.tags.hint': 'এই ফর্মটি শ্রেণীবদ্ধ ও সংগঠিত করতে সহায়ক লেবেল',
  ...
  'form.builder.details.users.with.access': 'এই অ্যাকশনগুলো সহ ব্যবহারকারীদের অ্যাক্সেস থাকবে',
  ...
  'form.builder.details.permissions.placeholder': 'অনুমতি কোড টাইপ করুন এবং Enter চাপুন',
  'form.builder.details.users.must.have.permission':
  ...
  'form.builder.details.add.fields.to.preview': 'প্রাকদর্শন দেখতে বিল্ডার ট্যাবে ফিল্ড যোগ করুন',
  ...
  'form.builder.public.response.recorded.success': 'আপনার প্রতিক্রিয়া সফলভাবে রেকর্ড করা হয়েছে।',
  ...
  'form.builder.error.form.not.available': 'এই ফর্মটি বিদ্যমান নেই বা উপলব্ধ নয়।',
  ...
  'form.builder.error.not.public': 'এই ফর্মটি পাবলিক অ্যাক্সেসের জন্য উপলব্ধ নয়।',
  ...
  'form.builder.toast.draft.saved.detail': 'আপনার অগ্রগতি স্থানীয়ভাবে সংরক্ষিত হয়েছে',
  ...
  'form.builder.tooltip.toggle.layout': 'বিভাগ-ভিত্তিক এবং ফ্ল্যাট ফর্ম লেআউটের মধ্যে টগল করুন',
  ...
  'form.builder.field.name.hint': 'জমা ডেটাতে কী হিসেবে ব্যবহৃত। ফর্মের মধ্যে অনন্য হতে হবে।',
  ...
  'form.builder.layout.grid.columns.hint': 'এই বিভাগের গ্রিড লেআউটে কলামের সংখ্যা।',
  ...
  'form.builder.email.pattern.hint': 'অনুমোদিত ইমেইল ডোমেইন সীমাবদ্ধ করতে রেগুলার এক্সপ্রেশন।',
  ...
  'form.builder.email.pattern.message.placeholder': 'যেমন, শুধু কোম্পানি ইমেইল গ্রহণযোগ্য',
  'form.builder.email.pattern.message.hint': 'ইমেইল প্যাটার্নের সাথে মেলে না হলে দেখানো হয়।',
  ...
  'form.builder.validation.no.options': 'কোনো বিকল্প যোগ করা হয়নি। কমপক্ষে একটি বিকল্প যোগ করুন।',
  ...
  'form.builder.computed.no.computed.fields': 'কোনো গণনাকৃত ফিল্ড সংজ্ঞায়িত নেই',
  'form.builder.computed.click.to.create': 'একটি তৈরি করতে "গণনাকৃত ফিল্ড যোগ করুন" ক্লিক করুন',
  ...
  'form.builder.computed.default.value.label': 'ডিফল্ট মান (কোনো নিয়ম না মিললে)',
  ...
  'form.builder.computed.no.condition.always': 'কোনো শর্ত নেই = সর্বদা প্রযোজ্য (যদি পৌঁছানো হয়)',
  ...
  'form.builder.logic.action.make.field.required.when': 'যখন ফিল্ড প্রয়োজনীয় করুন...',
  ...
  'form.builder.tooltip.conditional.visibility': 'শর্তাধীন দৃশ্যমানতা নিয়ম সক্রিয়',
  ...
  'form.builder.layout.click.form.fields': 'লেআউট সেটিংস সম্পাদনা করতে "ফর্ম ফিল্ড" ক্লিক করুন',
  ...
  'form.builder.result.fields.answered': '{{answered}} / {{total}} ফিল্ড উত্তর দেওয়া হয়েছে',
  ...
  'form.builder.validation.other.required': 'অনুগ্রহ করে {{label}} এর জন্য একটি মান উল্লেখ করুন',
  'form.builder.validation.email': 'অনুগ্রহ করে একটি বৈধ ইমেইল ঠিকানা লিখুন',
  'form.builder.validation.must.match.format': '{{label}} প্রয়োজনীয় ফরম্যাটের সাথে মিলতে হবে',
  'form.builder.validation.min.length': '{{label}} কমপক্ষে {{value}} অক্ষরের হতে হবে',
  'form.builder.validation.max.length': '{{label}} সর্বোচ্চ {{value}} অক্ষরের হতে হবে',
  ...
  'form.builder.schema.browser.only': 'এই বৈশিষ্ট্যটি শুধুমাত্র ব্রাউজারে উপলব্ধ',
  'form.builder.schema.read.failed': 'ফাইল পড়তে ব্যর্থ',
  'form.builder.validation.schema.must.be.object': 'স্কিমা একটি অবজেক্ট হতে হবে',
  'form.builder.validation.schema.id.required': 'স্কিমাতে একটি স্ট্রিং আইডি থাকতে হবে',
  'form.builder.validation.schema.name.required': 'স্কিমাতে একটি স্ট্রিং নাম থাকতে হবে',
  'form.builder.validation.schema.sections.required': 'স্কিমাতে একটি বিভাগ অ্যারে থাকতে হবে',
  'form.builder.validation.section.must.be.object': 'বিভাগ একটি অবজেক্ট হতে হবে',
  'form.builder.validation.section.id.required': 'বিভাগে একটি স্ট্রিং আইডি থাকতে হবে',
  'form.builder.validation.section.name.required': 'বিভাগে একটি স্ট্রিং নাম থাকতে হবে',
  'form.builder.validation.section.fields.required': 'বিভাগে একটি ফিল্ড অ্যারে থাকতে হবে',
  ...
  'form.builder.validation.field.id.required': 'ফিল্ডে একটি স্ট্রিং আইডি থাকতে হবে',
  'form.builder.validation.field.invalid.type': 'অবৈধ ফিল্ড টাইপ',
  'form.builder.validation.field.label.required': 'ফিল্ডে একটি স্ট্রিং লেবেল থাকতে হবে',
  'form.builder.validation.field.options.required': 'নির্বাচন ফিল্ডে একটি বিকল্প অ্যারে থাকতে হবে',
  ...
  'event.get.by.ids.success': 'আইডি অনুসারে ইভেন্টগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'event.get.by.filter.success': 'ফিল্টার অনুসারে ইভেন্টগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'event.participant.status.update.success': 'অংশগ্রহণকারীর স্থিতি সফলভাবে হালনাগাদ হয়েছে',
  ...
  'event.manager.event.saved.success': 'ইভেন্ট "{{title}}" সফলভাবে সংরক্ষিত হয়েছে।',
  ...
  'event.manager.no.events.in.company': 'বর্তমান কোম্পানিতে কোনো ইভেন্ট পাওয়া যায়নি',
  ...
  'event.manager.form.recurrence.end.hint': 'চিরকাল পুনরাবৃত্তি করতে ফাঁকা রাখুন',
  'event.manager.form.meeting.link': 'মিটিং লিঙ্ক',
  'event.manager.placeholder.meeting.link': 'https://meet.google.com/... (ঐচ্ছিক)',
  ...
  'notification.create.many.success': '{{count}}টি বিজ্ঞপ্তি সফলভাবে তৈরি হয়েছে',
  'notification.get.success': 'বিজ্ঞপ্তি সফলভাবে পুনরুদ্ধার হয়েছে',
  'notification.get.by.ids.success': 'আইডি অনুসারে বিজ্ঞপ্তিগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'notification.get.by.filter.success': 'ফিল্টার অনুসারে বিজ্ঞপ্তিগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'notification.update.many.success': '{{count}}টি বিজ্ঞপ্তি সফলভাবে হালনাগাদ হয়েছে',
  ...
  'notification.mark.all.read.success': '{{count}}টি বিজ্ঞপ্তি পঠিত হিসেবে চিহ্নিত',
  ...
  'notification.broadcast.success': '{{count}}টি বিজ্ঞপ্তি সফলভাবে পাঠানো হয়েছে',
  ...
  'task.board.member.get.all.success': 'বোর্ড সদস্যরা সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'task.manager.boards.subtitle': 'আপনার প্রকল্প বোর্ডগুলো পরিচালনা ও সংগঠিত করুন',
  ...
  'task.manager.board.list.empty': 'এখনো কোনো তালিকা নেই। "তালিকা যোগ করুন" ক্লিক করুন।',
  ...
  'language.get.by.ids.success': 'আইডি অনুসারে ভাষাগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'language.get.by.filter.success': 'ফিল্টার অনুসারে ভাষাগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'translation.key.create.many.success': '{{count}}টি অনুবাদ কী সফলভাবে তৈরি হয়েছে',
  'translation.key.get.success': 'অনুবাদ কী সফলভাবে পুনরুদ্ধার হয়েছে',
  'translation.key.get.by.ids.success': 'আইডি অনুসারে অনুবাদ কীগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'translation.key.update.many.success': '{{count}}টি অনুবাদ কী সফলভাবে হালনাগাদ হয়েছে',
  ...
  'translation.get.by.ids.success': 'আইডি অনুসারে অনুবাদগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  'translation.get.by.filter.success': 'ফিল্টার অনুসারে অনুবাদগুলো সফলভাবে পুনরুদ্ধার হয়েছে',
  ...
  'translation.update.many.success': '{{count}}টি অনুবাদ সফলভাবে হালনাগাদ হয়েছে',
  ...
  'localization.language.subtitle': 'আপনার অ্যাপ্লিকেশনের জন্য উপলব্ধ ভাষা ব্যবস্থাপনা করুন',
  ...
  'localization.language.empty': 'কোনো ভাষা কনফিগার করা নেই। শুরু করতে একটি ভাষা যোগ করুন।',
  'localization.language.confirm.set.default': '"{{name}}"-কে ডিফল্ট ভাষা হিসেবে সেট করবেন?',
  'localization.language.delete.title': 'ভাষা মুছুন',

  'localization.language.edit': 'ভাষা সম্পাদনা',
  'localization.placeholder.code': 'en',
  'localization.language.iso.code.hint': 'ISO 639-1 ভাষা কোড (যেমন, en, ar, fr)',
  'localization.placeholder.name': 'English',
  'localization.placeholder.native.name': 'English',
  'localization.language.native.name.hint': 'স্থানীয় ভাষায় নাম (যেমন, আরবির জন্য العربية)',
  ...
  'localization.validation.code.max.length': 'ভাষা কোড সর্বোচ্চ ১০ অক্ষরের হতে হবে',
  'localization.validation.name.required': 'ভাষার নাম প্রয়োজন',
  'localization.validation.name.max.length': 'ভাষার নাম সর্বোচ্চ ১০০ অক্ষরের হতে হবে',

  'localization.key.title': 'অনুবাদ কী',
  'localization.key.subtitle': 'আপনার অ্যাপ্লিকেশনের জন্য অনুবাদ কী ব্যবস্থাপনা করুন',
  ...
  'ai-assistant.history.forbidden.all': 'সকল ব্যবহারকারীর চ্যাট ইতিহাস দেখার অনুমতি নেই',
  ...
  'ai-assistant.subtitle': 'সহায়কের সাথে চ্যাট করুন এবং আপনার পিন করা ফলাফলগুলো আবার দেখুন',
  ...
  'ai-assistant.chat.greeting-hint': 'একটি নতুন কথোপকথন শুরু করুন অথবা সাইডবার থেকে একটি বেছে নিন',
  'ai-assistant.chat.readonly-banner': '{{user}}-এর কথোপকথন দেখা হচ্ছে (শুধুমাত্র পঠনযোগ্য)',
  'ai-assistant.pinned.empty': 'এখনো কোনো পিন করা ফলাফল নেই',
  'ai-assistant.pinned.empty.hint': 'এখানে দেখতে সহায়কের চ্যাট থেকে একটি উত্তর পিন করুন',
  ...
  'ai-assistant.pinned.select-hint': 'দেখতে তালিকা থেকে একটি পিন করা ফলাফল নির্বাচন করুন',
};
...
export const ARABIC_TRANSLATIONS = {
  ...
  'error.permission.system.unavailable': 'نظام الصلاحيات غير متاح مؤقتاً. يرجى المحاولة لاحقاً.',
  'error.insufficient.permissions': 'الصلاحيات المطلوبة مفقودة: {{permissions}}',
  'error.insufficient.permissions.or': 'يتطلب واحداً على الأقل من: {{permissions}}',
  'error.no.permissions.found': 'لم يتم العثور على صلاحيات. يرجى الاتصال بالمسؤول.',
  ...
  'system.service.not.available': 'الخدمة "{{provider}}" غير متاحة. المتاح: {{available}}',
  ...
  'system.sdk.not.installed': 'SDK المطلوب "{{sdk}}" غير مثبت. شغّل: npm install {{sdk}}',
  ...
  'shared.search': 'بحث',
  'shared.pagination.report': 'عرض {first} إلى {last} من أصل {totalRecords} سجل',
  'shared.select': 'اختر...',
  ...
  'layout.configurator.layout.theme': 'التخطيط',
  'layout.configurator.layout.theme.classic': 'كلاسيكي',
  'layout.configurator.layout.theme.modern': 'حديث',
  ...
  'menu.components': 'المكونات',
  'menu.components.display': 'العرض',
  'menu.components.menu': 'القائمة',
  'menu.components.form': 'النموذج',
  'menu.components.overlay': 'التراكب',
  'menu.components.data': 'البيانات',
  'menu.components.panel': 'اللوحة',
  'menu.components.media': 'الوسائط',
  'menu.components.misc': 'التوجيهات',
  ...
  'auth.login.email.not.verified': 'يرجى التحقق من بريدك الإلكتروني قبل تسجيل الدخول',
  ...
  'auth.password.reset.token.expired': 'انتهت صلاحية رمز إعادة تعيين كلمة المرور',
  'auth.password.reset.token.used': 'تم استخدام رمز إعادة تعيين كلمة المرور بالفعل',
  ...
  'auth.validation.password.min.length': 'يجب أن تكون كلمة المرور 8 أحرف على الأقل',
  ...
  'auth.validation.password.require.number': 'يجب أن تحتوي كلمة المرور على رقم واحد على الأقل',
  'auth.validation.password.require.special': 'يجب أن تحتوي كلمة المرور على رمز خاص واحد على الأقل',
  ...
  'auth.forgot.password.subtitle': 'أدخل عنوان بريدك الإلكتروني وسنرسل لك رابط إعادة التعيين.',
  ...
  'auth.forgot.password.email.sent.to': 'أرسلنا رابط إعادة تعيين كلمة المرور إلى {{email}}',
  ...
  'auth.verify.email.please.wait': 'يرجى الانتظار بينما نتحقق من عنوان بريدك الإلكتروني...',
  ...
  'auth.verify.email.invalid.link': 'رابط التحقق هذا غير صالح أو انتهت صلاحيته.',
  'auth.verify.email.resend.email': 'إعادة إرسال بريد التحقق',
  'auth.verify.email.resend.title': 'إعادة إرسال التحقق',
  'auth.verify.email.resend.subtitle': 'أدخل بريدك الإلكتروني لاستلام رابط تحقق جديد.',
  'auth.verify.email.resend': 'إعادة إرسال البريد',
  'auth.verify.email.sent': 'تم إرسال بريد التحقق. يرجى التحقق من صندوق الوارد.',
  ...
  'auth.reset.password.confirm.password.placeholder': 'أكّد كلمة المرور الجديدة',
  ...
  'user.profile.section.data.success': 'تم استرجاع بيانات قسم الملف الشخصي بنجاح',
  ...
  'user.permission.batch.success': 'تمت معالجة {{added}} إضافة و{{removed}} إزالة',
  ...
  'administrative.permission.no.company': 'لا توجد صلاحيات شركة معيّنة لهذا المستخدم.',
  'administrative.permission.assign.company.first':
    'عيّن صلاحيات الشركة أولاً قبل إدارة الوصول إلى الفرع.',
  'administrative.permission.select.company.for.branches': 'يرجى اختيار شركة لعرض الفروع.',
  ...
  'administrative.user.auto.assign.to': 'سيتم تعيين المستخدم الجديد تلقائياً إلى',
  ...
  'profile.storage.not.enabled': 'رفع صورة الملف الشخصي غير متاح. خدمة التخزين غير مُعدّة.',
  ...
  'user.action.permission.get.success': 'تم استرجاع صلاحيات إجراءات المستخدم بنجاح',

  'company.action.permission.get.success': 'تم استرجاع صلاحيات إجراءات الشركة بنجاح',
  ...
  'iam.direct.mode.unavailable': 'تعيين الصلاحية المباشرة غير متاح في وضع RBAC فقط',
  'iam.rbac.mode.unavailable': 'تعيين الصلاحية القائمة على الأدوار غير متاح في وضع المباشر فقط',
  'iam.role.assignment.unavailable': 'تعيين الأدوار غير متاح في وضع المباشر فقط',
  ...
  'iam.logic.description': 'حدد متطلبات الصلاحيات باستخدام منطق AND/OR مع الإجراءات',
  ...
  'iam.branch.permitted.count.plural': '{{count}} فرع مسموح به في الشركة الحالية',
  ...
  'iam.permission.prerequisite.validation.failed': 'فشل التحقق من المتطلبات المسبقة',
  'iam.permission.prerequisite.error.message': 'الإجراءات التالية لها متطلبات غير مستوفاة:',
  ...
  'iam.permission.selection.reverted': 'تم التراجع عن التحديد إلى الحالة الأولية.',
  ...
  'iam.pagination.roles.template': 'عرض {first} إلى {last} من {totalRecords} دور',
  ...
  'iam.logic.validation.failed.message': 'الإجراءات التالية لها متطلبات غير مستوفاة:',
  ...
  'iam.logic.fix.prerequisites.manually': 'يرجى إصلاح المتطلبات يدوياً قبل الحفظ',
  ...
  'iam.logic.action.selected.detail': 'تم تحديد الإجراء بنجاح (المتطلبات مستوفاة بالفعل)',
  'iam.logic.auto.selected.detail': 'تم تحديد {{count}} إجراء(ات) تلقائياً بما في ذلك المتطلبات',
  'iam.logic.minimum.required': ' (الحد الأدنى المطلوب)',
  'iam.logic.auto.select.prompt': 'سيحدد التحديد التلقائي {{count}} إجراء(ات){{suffix}}.',
  ...
  'iam.logic.switched.to.alternatives': 'تم التبديل تلقائياً إلى إجراء(ات) بديلة',
  'iam.logic.actions.removed': 'تمت إزالة الإجراءات',
  'iam.logic.removed.with.dependents': 'تمت إزالة {{name}} و{{count}} إجراء(ات) تابعة',
  ...
  'storage.config.create.many.success': 'تم إنشاء {{count}} إعدادات تخزين بنجاح',
  'storage.config.get.success': 'تم استرجاع إعدادات التخزين بنجاح',
  'storage.config.get.by.ids.success': 'تم استرجاع إعدادات التخزين بالمعرفات بنجاح',
  'storage.config.get.by.filter.success': 'تم استرجاع إعدادات التخزين بالفلتر بنجاح',
  ...
  'storage.config.update.many.success': 'تم تحديث {{count}} إعدادات تخزين بنجاح',
  ...
  'upload.file.too.large': 'حجم الملف ({{fileSize}}MB) يتجاوز الحد الأقصى {{maxSize}}MB',
  'upload.invalid.type': 'نوع الملف "{{mimeType}}" غير مسموح. المسموح: {{allowedTypes}}',
  ...
  'storage.empty.configs.in.company': 'لم يتم العثور على إعدادات تخزين في الشركة الحالية',
  ...
  'storage.delete.move.to.trash.confirm': 'نقل "{{name}}" إلى المهملات؟ يمكنك استعادته لاحقاً.',
  ...
  'storage.config.no.configs': 'لم يتم العثور على إعدادات تخزين. يرجى إنشاء واحدة أولاً.',
  'storage.folder.optional': 'المجلد (اختياري)',
  'storage.folder.no.folder': 'لا يوجد مجلد (المستوى الجذر)',
  'storage.folder.no.folders.available': 'لا توجد مجلدات متاحة. سيتم رفع الملف إلى المستوى الجذر.',
  ...
  'storage.empty.folders.in.company': 'لم يتم العثور على مجلدات في الشركة الحالية',
  ...
  'email.config.create.many.success': 'تم إنشاء {{count}} إعدادات بريد إلكتروني بنجاح',
  ...
  'email.config.get.by.ids.success': 'تم استرجاع إعدادات البريد الإلكتروني بالمعرفات بنجاح',
  'email.config.get.by.filter.success': 'تم استرجاع إعدادات البريد الإلكتروني بالفلتر بنجاح',
  'email.config.update.success': 'تم تحديث إعدادات البريد الإلكتروني بنجاح',
  'email.config.update.many.success': 'تم تحديث {{count}} إعدادات بريد إلكتروني بنجاح',
  ...
  'email.template.get.by.ids.success': 'تم استرجاع قوالب البريد الإلكتروني بالمعرفات بنجاح',
  'email.template.get.by.filter.success': 'تم استرجاع قوالب البريد الإلكتروني بالفلتر بنجاح',
  'email.template.get.all.success': 'تم استرجاع قوالب البريد الإلكتروني بنجاح',
  'email.template.create.many.success': 'تم إنشاء {{count}} قوالب بريد إلكتروني بنجاح',
  'email.template.update.many.success': 'تم تحديث {{count}} قوالب بريد إلكتروني بنجاح',
  ...
  'email.send.config.default.not.found': 'إعدادات البريد الإلكتروني الافتراضية غير موجودة',
  ...
  'email.send.template.id.or.slug.required': 'معرّف القالب أو المعرّف النصي مطلوب',
  ...
  'email.recipient.example': 'recipient@example.com',
  'email.config.test.dialog.hint': 'سيتم إرسال بريد إلكتروني اختباري للتحقق من الإعدادات',
  ...
  'email.template.select.config.and.recipient': 'يرجى اختيار إعدادات بريد إلكتروني وإدخال مستلم',
  ...
  'form.permission.check.failed': 'تعذر التحقق من الصلاحيات. يرجى المحاولة مرة أخرى.',
  ...
  'form.builder.details.users.with.access': 'سيكون لدى المستخدمين بهذه الإجراءات حق الوصول',
  ...
  'form.builder.details.permissions.placeholder': 'اكتب رمز الصلاحية واضغط Enter',
  'form.builder.details.users.must.have.permission':
  ...
  'form.builder.details.response.mode.multiple.hint': 'يمكن للمستخدمين إرسال استجابات غير محدودة.',
  'form.builder.details.form.is.active': 'النموذج نشط',
  'form.builder.details.add.fields.to.preview': 'أضف حقولاً في علامة تبويب المُنشئ لرؤية المعاينة',
  ...
  'form.builder.details.access.authenticated': 'مصادق عليه (يتطلب تسجيل الدخول)',
  ...
  'form.builder.public.already.submitted.description': 'لقد أرسلت بالفعل استجابة لهذا النموذج.',
  'form.builder.public.single.submission.note': 'يسمح هذا النموذج بإرسال واحد فقط لكل مستخدم.',
  ...
  'form.builder.tooltip.toggle.layout': 'التبديل بين التخطيط القائم على الأقسام والتخطيط المسطح',
  ...
  'form.builder.layout.grid.columns.hint': 'عدد الأعمدة في تخطيط الشبكة لهذا القسم.',
  ...
  'form.builder.email.pattern.hint': 'تعبير نمطي لتقييد نطاقات البريد الإلكتروني المقبولة.',
  ...
  'form.builder.email.pattern.message.placeholder': 'مثل، يُقبل فقط البريد الإلكتروني للشركة',
  'form.builder.email.pattern.message.hint': 'تظهر عندما لا يطابق البريد الإلكتروني النمط.',
  ...
  'form.builder.validation.unlimited.hint': 'اترك فارغاً للتحديدات غير المحدودة.',
  'form.builder.validation.max.files': 'الحد الأقصى للملفات',
  'form.builder.validation.max.file.size': 'الحد الأقصى لحجم الملف (بايت)',
  'form.builder.validation.no.options': 'لم تتم إضافة خيارات. أضف خياراً واحداً على الأقل.',
  ...
  'form.builder.section.visibility.hint': 'التحكم في متى يظهر هذا القسم بناءً على قيم الحقول.',
  ...
  'form.builder.computed.click.to.create': 'انقر على "إضافة حقل محسوب" لإنشاء واحد',
  ...
  'form.builder.computed.default.value.label': 'القيمة الافتراضية (إذا لم تتطابق أي قاعدة)',
  ...
  'form.builder.computed.no.rules.defined': 'لا توجد قواعد محددة. أضف قاعدة لتكوين الحساب.',
  ...
  'form.builder.computed.no.condition.always': 'لا شرط = يُطبّق دائماً (إذا تم الوصول)',
  ...
  'form.builder.logic.action.make.field.required.when': 'جعل الحقل مطلوباً عندما...',
  'form.builder.logic.action.jump.to.section.when': 'الانتقال إلى القسم عندما...',
  ...
  'form.builder.logic.action.hide.this.section.when': 'إخفاء هذا القسم عندما...',
  'form.builder.logic.action.show.this.section.when': 'إظهار هذا القسم عندما...',
  ...
  'form.builder.layout.responsive.hint': 'ضبط الأعمدة تلقائياً بناءً على حجم الشاشة.',
  ...
  'form.builder.layout.click.form.fields': 'انقر على "حقول النموذج" لتعديل إعدادات التخطيط',
  ...
  'form.builder.result.fields.answered': '{{answered}} / {{total}} حقل تم الإجابة عليه',
  'form.builder.result.computed.title': 'النتائج المحسوبة',
  'form.builder.result.computed.subtitle': 'محسوبة تلقائياً بناءً على استجاباتك',
  ...
  'form.builder.validation.must.match.format': 'يجب أن يطابق {{label}} التنسيق المطلوب',
  'form.builder.validation.min.length': 'يجب أن يكون {{label}} {{value}} حرف على الأقل',
  'form.builder.validation.max.length': 'يجب أن يكون {{label}} {{value}} حرف على الأكثر',
  ...
  'form.builder.validation.schema.id.required': 'يجب أن يحتوي المخطط على معرّف نصي',
  'form.builder.validation.schema.name.required': 'يجب أن يحتوي المخطط على اسم نصي',
  'form.builder.validation.schema.sections.required': 'يجب أن يحتوي المخطط على مصفوفة أقسام',
  'form.builder.validation.section.must.be.object': 'يجب أن يكون القسم كائناً',
  'form.builder.validation.section.id.required': 'يجب أن يحتوي القسم على معرّف نصي',
  'form.builder.validation.section.name.required': 'يجب أن يحتوي القسم على اسم نصي',
  'form.builder.validation.section.fields.required': 'يجب أن يحتوي القسم على مصفوفة حقول',
  ...
  'form.builder.validation.field.id.required': 'يجب أن يحتوي الحقل على معرّف نصي',
  'form.builder.validation.field.invalid.type': 'نوع حقل غير صالح',
  'form.builder.validation.field.label.required': 'يجب أن يحتوي الحقل على تسمية نصية',
  'form.builder.validation.field.options.required': 'يجب أن يحتوي حقل الاختيار على مصفوفة خيارات',
  ...
  'event.manager.no.events.in.company': 'لم يتم العثور على أحداث في الشركة الحالية',
  ...
  'event.manager.placeholder.recurrence.end': 'اترك فارغاً لعدم وجود تاريخ نهاية',
  'event.manager.form.recurrence.end.hint': 'اترك فارغاً للتكرار إلى الأبد',
  'event.manager.form.meeting.link': 'رابط الاجتماع',
  'event.manager.placeholder.meeting.link': 'https://meet.google.com/... (اختياري)',
  ...
  'translation.key.get.by.ids.success': 'تم استرجاع مفاتيح الترجمة بالمعرفات بنجاح',
  'translation.key.get.by.filter.success': 'تم استرجاع مفاتيح الترجمة بالفلتر بنجاح',
  ...
  'translation.key.readonly.delete.forbidden': 'لا يمكن حذف مفاتيح الترجمة للقراءة فقط: {{keys}}',
  'translation.key.readonly.update.forbidden':
  ...
  'localization.language.confirm.set.default': 'تعيين "{{name}}" كاللغة الافتراضية؟',
  ...
  'localization.placeholder.name': 'English',
  'localization.placeholder.native.name': 'English',
  'localization.language.native.name.hint': 'الاسم باللغة الأصلية (مثل، العربية للعربية)',
  ...
  'localization.validation.code.max.length': 'يجب أن يكون رمز اللغة 10 أحرف على الأكثر',
  'localization.validation.name.required': 'اسم اللغة مطلوب',
  'localization.validation.name.max.length': 'يجب أن يكون اسم اللغة 100 حرف على الأكثر',
  ...
  'localization.placeholder.default.message': 'أدخل القيمة الافتراضية (بالإنجليزية)',
  ...
  'localization.key.variables.hint': 'أدخل أسماء المتغيرات المستخدمة في هذه الترجمة',
  ...
  'localization.validation.default.message.required': 'الرسالة الافتراضية مطلوبة',
  ...
  'task.manager.board.list.empty': 'لا توجد قوائم بعد. انقر على "إضافة قائمة" لإنشاء واحدة.',
  ...
  'ai-assistant.history.forbidden.all': 'غير مسموح لك بعرض سجل دردشة جميع المستخدمين',
  ...
  'ai-assistant.chat.greeting-hint': 'ابدأ محادثة جديدة أو اختر واحدة من الشريط الجانبي',
...
async function seedLocalization(): Promise<void> {
  ...
  const dbType = (migrationConfig.defaultDatabaseConfig.type as string).toLowerCase();
  ...
  const qid = (name: string): string => (isPostgres ? `"${name}"` : `\`${name}\``);

  // Boolean value: PostgreSQL BOOLEAN columns need true/false; MySQL uses 1/0
  const bv = (val: boolean): boolean | number => (isPostgres ? val : val ? 1 : 0);
  ...
  try {
    ...
    for (const lang of DEFAULT_LANGUAGES) {
      const existingLang = (
        await queryRunner.query(
          ...q(`SELECT id FROM language WHERE code = ? AND deleted_at IS NULL LIMIT 1`, [
            lang.code,
          ]),
        )
      )[0];
    ...
    for (const moduleConfig of MODULE_CONFIGS) {
      ...
      for (const [key, defaultMessage] of Object.entries(moduleConfig.messages)) {
        ...
        if (!existingKey) {
          ...
          await queryRunner.query(
            ...q(`UPDATE translation_key SET module = ? WHERE id = ? AND module != ?`, [
              keyModule,
              keyId,
              keyModule,
            ]),
            ...
            await queryRunner.query(
              ...q(
                `INSERT INTO translation (id, language_id, translation_key_id, value, is_verified, is_active)
                 VALUES (?, ?, ?, ?, ?, ?)`,
                [uuidv4(), langId, keyId, translatedValue, bv(lang.code === 'en'), bv(true)],
              ),
            );
      ...
      console.log(`      ✓ Created: ${moduleKeysCreated}, Existing: ${moduleKeysExist}`);
    }
    ...
    for (const config of MODULE_CONFIGS) {
      ...
      console.log(`   ${status} ${config.name}: ${count} keys (is_readonly=${config.readOnly})`);
    }
