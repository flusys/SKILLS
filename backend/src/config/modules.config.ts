...
export const moduleEventsConfig: Record<FeatureModuleName, IModuleEventsConfig> =
  {
    auth: {
      ...
      actions: [
        ...
        `session.${AUTH_EVENT_ACTIONS.SOCIAL_LOGGED_IN}`,
        ...
        "social_auth_config.created",
        "social_auth_config.updated",
        "social_auth_config.deleted",
        "social_auth_config.restored",
        "social_auth_config.purged",
      ],
