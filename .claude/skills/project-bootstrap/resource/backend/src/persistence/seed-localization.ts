...
export const BENGALI_TRANSLATIONS = {
  ...
  "error.permission.system.unavailable": "অনুমতি সিস্টেম সাময়িকভাবে অনুপলব্ধ। অনুগ্রহ করে পরে আবার চেষ্টা করুন।",
  ...
  "error.no.permissions.found": "কোনো অনুমতি পাওয়া যায়নি। অনুগ্রহ করে প্রশাসকের সাথে যোগাযোগ করুন।",
  ...
  "system.tenant.header.required": "টেনান্ট পাওয়া যায়নি। নিশ্চিত করুন \"{{header}}\" হেডার সেট করা আছে।",
  "system.missing.parameter": "প্রয়োজনীয় প্যারামিটার অনুপস্থিত: {{key}}",
  "system.sdk.not.installed": "প্রয়োজনীয় SDK \"{{sdk}}\" ইনস্টল করা নেই। চালান: npm install {{sdk}}",
  ...
  "shared.upload.provider.not.configured": "ফাইল আপলোড কনফিগার করা নেই। আপনার অ্যাপ কনফিগে {{provider}} যোগ করুন।",
  ...
  "shared.file.uploader.no.upload.function": "কোনো আপলোড ফাংশন উপলব্ধ নেই। FILE_PROVIDER কনফিগার করুন বা uploadFile ইনপুট প্রদান করুন।",
  ...
  "auth.login.select.company.message": "চালিয়ে যেতে অনুগ্রহ করে একটি কোম্পানি ও শাখা নির্বাচন করুন",
  ...
  "auth.forgot.password.subtitle": "আপনার ইমেইল ঠিকানা লিখুন এবং আমরা আপনাকে একটি রিসেট লিঙ্ক পাঠাব।",
  ...
  "auth.verify.email.please.wait": "আমরা আপনার ইমেইল ঠিকানা যাচাই করার সময় অনুগ্রহ করে অপেক্ষা করুন...",
  "auth.verify.email.success": "ইমেইল যাচাই হয়েছে",
  "auth.verify.email.success.message": "আপনার ইমেইল সফলভাবে যাচাই হয়েছে। আপনি এখন আপনার অ্যাকাউন্টে লগইন করতে পারেন।",
  ...
  "auth.reset.password.success.message": "আপনার পাসওয়ার্ড সফলভাবে রিসেট হয়েছে। আপনি এখন আপনার নতুন পাসওয়ার্ড দিয়ে লগইন করতে পারেন।",
  "auth.reset.password.invalid.link": "অবৈধ রিসেট লিঙ্ক",
  "auth.reset.password.invalid.link.message": "এই পাসওয়ার্ড রিসেট লিঙ্কটি অবৈধ বা মেয়াদ শেষ হয়ে গেছে।",
  ...
  "user.permission.batch.success": "{{added}}টি সংযোজন এবং {{removed}}টি অপসারণ প্রক্রিয়া করা হয়েছে",
  ...
  "administrative.permission.assign.company.first": "শাখা অ্যাক্সেস ব্যবস্থাপনার আগে প্রথমে কোম্পানির অনুমতি অর্পণ করুন।",
  "administrative.permission.select.company.for.branches": "শাখা দেখতে অনুগ্রহ করে একটি কোম্পানি নির্বাচন করুন।",
  ...
  "permission.process.success": "সফলভাবে {{total}}টি আইটেম প্রক্রিয়া হয়েছে: {{added}}টি যোগ, {{removed}}টি অপসারণ",
  ...
  "iam.logic.description": "অ্যাকশন সহ AND/OR যুক্তি ব্যবহার করে অনুমতির প্রয়োজনীয়তা সংজ্ঞায়িত করুন",
  ...
  "iam.validation.unmet.prerequisites.plural": "{{count}}টি নির্বাচিত অ্যাকশনের অপূর্ণ পূর্বশর্ত রয়েছে। সংরক্ষণের আগে ঠিক করুন বা সংরক্ষণে স্বয়ংক্রিয়-ঠিকাকরণ ব্যবহার করুন।",
  "iam.validation.unmet.prerequisites.singular": "{{count}}টি নির্বাচিত অ্যাকশনের অপূর্ণ পূর্বশর্ত রয়েছে। সংরক্ষণের আগে ঠিক করুন বা সংরক্ষণে স্বয়ংক্রিয়-ঠিকাকরণ ব্যবহার করুন।",
  "iam.permission.requirements": "প্রয়োজনীয়তা",
  "iam.validation.unmet.prerequisites.tooltip": "এই অ্যাকশনের অপূর্ণ পূর্বশর্ত রয়েছে এবং সংরক্ষণে যাচাইকরণ ব্যর্থ হবে",
  ...
  "iam.permission.auto.selected.prerequisites": "প্রয়োজনীয় পূর্বশর্ত স্বয়ংক্রিয়ভাবে নির্বাচিত হয়েছে। পরিবর্তন প্রয়োগ করতে সংরক্ষণে ক্লিক করুন।",
  ...
  "iam.pagination.roles.template": "{totalRecords}টি ভূমিকার মধ্যে {first} থেকে {last} দেখানো হচ্ছে",
  ...
  "iam.logic.removed.actions.detail": "অপূর্ণ পূর্বশর্ত সহ {{count}}টি অ্যাকশন সরানো হয়েছে। আপনি এখন সংরক্ষণ করতে পারেন।",
  "iam.logic.save.cancelled": "সংরক্ষণ বাতিল",
  "iam.logic.fix.prerequisites.manually": "অনুগ্রহ করে সংরক্ষণের আগে ম্যানুয়ালি পূর্বশর্ত ঠিক করুন",
  "iam.logic.prerequisites.satisfied": "[OK] পূর্বশর্ত পূরণ",
  "iam.logic.all.required.selected": "সমস্ত প্রয়োজনীয় অ্যাকশন ইতিমধ্যে নির্বাচিত।\nআপনি নিরাপদে এই অ্যাকশন যোগ করতে পারেন।",
  ...
  "storage.config.get.by.ids.success": "আইডি অনুসারে স্টোরেজ কনফিগারেশনগুলো সফলভাবে পুনরুদ্ধার হয়েছে",
  "storage.config.get.by.filter.success": "ফিল্টার অনুসারে স্টোরেজ কনফিগারেশনগুলো সফলভাবে পুনরুদ্ধার হয়েছে",
  ...
  "storage.delete.move.to.trash.confirm": "\"{{name}}\" ট্র্যাশে সরান? আপনি পরে এটি পুনরুদ্ধার করতে পারেন।",
  "storage.delete.move.to.trash": "ট্র্যাশে সরান",
  "storage.delete.permanent.delete.confirm": "\"{{name}}\" স্থায়ীভাবে মুছবেন? এই ক্রিয়াটি পূর্বাবস্থায় ফেরানো যাবে না এবং স্টোরেজ থেকে ফাইলটি মুছে ফেলবে।",
  ...
  "storage.config.no.configs": "কোনো স্টোরেজ কনফিগারেশন পাওয়া যায়নি। অনুগ্রহ করে প্রথমে একটি তৈরি করুন।",
  ...
  "email.config.get.by.filter.success": "ফিল্টার অনুসারে ইমেইল কনফিগারেশনগুলো সফলভাবে পুনরুদ্ধার হয়েছে",
  ...
  "email.template.get.by.filter.success": "ফিল্টার অনুসারে ইমেইল টেমপ্লেটগুলো সফলভাবে পুনরুদ্ধার হয়েছে",
  ...
  "email.template.plain.text.hint": "HTML সমর্থন করে না এমন ইমেইল ক্লায়েন্টের জন্য সরল পাঠ্য ব্যবহৃত হয়",
  ...
  "email.template.select.config.and.recipient": "অনুগ্রহ করে একটি ইমেইল কনফিগারেশন নির্বাচন করুন এবং প্রাপক লিখুন",
  ...
  "form.builder.details.no.actions.available": "কোনো অ্যাকশন উপলব্ধ নেই। প্রথমে IAM মডিউলে অ্যাকশন কনফিগার করুন।",
  ...
  "form.builder.details.action.codes.required": "এই অ্যাকশন কোডগুলো ফর্ম অ্যাক্সেসের জন্য প্রয়োজন হবে",
  ...
  "form.builder.details.users.must.have.permission": "ব্যবহারকারীদের জমা দিতে এই অনুমতিগুলোর একটি থাকতে হবে",
  "form.builder.details.response.type": "প্রতিক্রিয়া টাইপ",
  "form.builder.details.response.mode.single.hint": "প্রতিটি ব্যবহারকারী শুধু একবার জমা দিতে পারেন। প্রমাণীকৃত ব্যবহারকারীদের জন্য, বিদ্যমান জমা চেক করে এটি প্রয়োগ করা হয়। পাবলিক ফর্মগুলোর জন্য, এটি ব্রাউজার স্টোরেজ ব্যবহার করে।",
  "form.builder.details.response.mode.multiple.hint": "ব্যবহারকারীরা অসীম সংখ্যক প্রতিক্রিয়া জমা দিতে পারেন।",
  ...
  "form.builder.public.access.restricted.description": "এই ফর্মটি দেখার বা জমা দেওয়ার জন্য আপনার প্রয়োজনীয় অনুমতি নেই। আপনি যদি মনে করেন এটি একটি ত্রুটি তাহলে অনুগ্রহ করে আপনার প্রশাসকের সাথে যোগাযোগ করুন।",
  "form.builder.public.login.required": "এই ফর্মের জন্য আপনাকে লগইন করতে হবে।",
  "form.builder.public.permission.required": "এই ফর্মের জন্য নির্দিষ্ট অনুমতি প্রয়োজন। চালিয়ে যেতে অনুগ্রহ করে লগইন করুন।",
  ...
  "form.builder.public.draft.saved.description": "এই ফর্মের জন্য আপনার একটি সংরক্ষিত খসড়া আছে। আপনি কি যেখানে ছেড়েছিলেন সেখান থেকে চালিয়ে যেতে চান?",
  "form.builder.public.schema.change.warning": "দ্রষ্টব্য: আপনি খসড়া সংরক্ষণের পর থেকে ফর্মটি হালনাগাদ হয়েছে। কিছু ফিল্ড পরিবর্তিত হতে পারে।",
  ...
  "form.builder.public.already.submitted.description": "আপনি ইতিমধ্যে এই ফর্মে একটি প্রতিক্রিয়া জমা দিয়েছেন।",
  "form.builder.public.single.submission.note": "এই ফর্মটি প্রতি ব্যবহারকারীকে শুধু একটি জমা অনুমতি দেয়।",
  ...
  "form.builder.toast.draft.not.saved.detail": "খসড়া সংরক্ষণ করা যাচ্ছে না। আপনার ব্রাউজার প্রাইভেট মোডে থাকতে পারে বা স্টোরেজ পূর্ণ।",
  ...
  "form.builder.result.version.notice": "এই জমাটি ফর্ম সংস্করণ v{{submissionVersion}} দিয়ে করা হয়েছিল। বর্তমান ফর্ম সংস্করণ v{{currentVersion}}।",
  ...
  "form.builder.section.visibility.hint": "ফিল্ড মানের উপর ভিত্তি করে এই বিভাগ কখন দেখানো হবে তা নিয়ন্ত্রণ করুন।",
  "form.builder.logic.conditional.rules": "শর্তাধীন নিয়ম",
  "form.builder.logic.conditional.rules.hint": "অন্যান্য ফিল্ড মানের উপর ভিত্তি করে দৃশ্যমানতা বা প্রয়োজনীয়তা নিয়ন্ত্রণ করতে নিয়ম যোগ করুন।",
  ...
  "form.builder.logic.add.conditional.logic": "এই ফিল্ডটি কখন প্রদর্শিত বা প্রয়োজনীয় হবে তা নিয়ন্ত্রণ করতে শর্তাধীন যুক্তি যোগ করুন।",
  ...
  "form.builder.computed.define.fields": "জমা দেওয়ার সময় ফর্ম প্রতিক্রিয়া থেকে গণনা করা ফিল্ড সংজ্ঞায়িত করুন",
  ...
  "form.builder.computed.rules.evaluation.order": "নিয়মগুলো ক্রম অনুসারে মূল্যায়ন করা হয়। প্রথম মিলে যাওয়া নিয়ম প্রয়োগ হয়।",
  "form.builder.computed.no.rules.defined": "কোনো নিয়ম সংজ্ঞায়িত নেই। গণনা কনফিগার করতে একটি নিয়ম যোগ করুন।",
  ...
  "form.builder.layout.responsive.hint": "স্ক্রিনের আকারের উপর ভিত্তি করে স্বয়ংক্রিয়ভাবে কলাম সামঞ্জস্য করুন।",
  ...
  "form.builder.layout.select.field.to.edit": "অথবা একটি ফিল্ড নির্বাচন করুন এর বৈশিষ্ট্য সম্পাদনা করতে",
  "form.builder.layout.select.to.edit": "এর বৈশিষ্ট্য সম্পাদনা করতে একটি ফিল্ড বা বিভাগ নির্বাচন করুন",
  ...
  "form.builder.result.computed.subtitle": "আপনার প্রতিক্রিয়ার উপর ভিত্তি করে স্বয়ংক্রিয়-গণনাকৃত",
  ...
  "translation.key.get.by.filter.success": "ফিল্টার অনুসারে অনুবাদ কীগুলো সফলভাবে পুনরুদ্ধার হয়েছে",
  ...
  "translation.key.readonly.delete.forbidden": "শুধু-পাঠযোগ্য অনুবাদ কী মুছে ফেলা যাবে না: {{keys}}",
  "translation.key.readonly.update.forbidden": "সিস্টেম অনুবাদ কীর কী বা মডিউল পরিবর্তন করা যাবে না",
  "translation.key.duplicate.key.in.module": "অনুবাদ কী \"{{key}}\" ইতিমধ্যে মডিউল \"{{module}}\" এ বিদ্যমান",
...
export const ARABIC_TRANSLATIONS = {
  ...
  "system.tenant.header.required": "لم يتم العثور على المستأجر. تأكد من تعيين الترويسة \"{{header}}\".",
  ...
  "shared.upload.provider.not.configured": "رفع الملف غير مُعد. أضف {{provider}} إلى إعدادات التطبيق.",
  ...
  "shared.file.uploader.no.upload.function": "لا توجد دالة رفع متاحة. قم بتكوين FILE_PROVIDER أو قدم مدخل uploadFile.",
  ...
  "auth.validation.password.require.uppercase": "يجب أن تحتوي كلمة المرور على حرف كبير واحد على الأقل",
  "auth.validation.password.require.lowercase": "يجب أن تحتوي كلمة المرور على حرف صغير واحد على الأقل",
  ...
  "auth.verify.email.success.message": "تم التحقق من بريدك الإلكتروني بنجاح. يمكنك الآن تسجيل الدخول إلى حسابك.",
  ...
  "auth.reset.password.success.message": "تمت إعادة تعيين كلمة المرور بنجاح. يمكنك الآن تسجيل الدخول باستخدام كلمة المرور الجديدة.",
  "auth.reset.password.invalid.link": "رابط إعادة تعيين غير صالح",
  "auth.reset.password.invalid.link.message": "رابط إعادة تعيين كلمة المرور هذا غير صالح أو انتهت صلاحيته.",
  ...
  "administrative.permission.assign.company.first": "عيّن صلاحيات الشركة أولاً قبل إدارة الوصول إلى الفرع.",
  ...
  "permission.process.success": "تمت معالجة {{total}} عنصر بنجاح: {{added}} مضاف، {{removed}} مُزال",
  ...
  "iam.validation.unmet.prerequisites.plural": "{{count}} إجراءات محددة لها متطلبات غير مستوفاة. قم بإصلاحها قبل الحفظ أو استخدم الإصلاح التلقائي عند الحفظ.",
  "iam.validation.unmet.prerequisites.singular": "{{count}} إجراء محدد له متطلبات غير مستوفاة. قم بإصلاحه قبل الحفظ أو استخدم الإصلاح التلقائي عند الحفظ.",
  "iam.permission.requirements": "المتطلبات",
  "iam.validation.unmet.prerequisites.tooltip": "هذا الإجراء لديه متطلبات غير مستوفاة وسيفشل في التحقق عند الحفظ",
  ...
  "iam.permission.auto.selected.prerequisites": "تم تحديد المتطلبات المسبقة تلقائياً. انقر على حفظ لتطبيق التغييرات.",
  ...
  "iam.logic.removed.actions.detail": "تمت إزالة {{count}} إجراء(ات) بمتطلبات غير مستوفاة. يمكنك الحفظ الآن.",
  ...
  "iam.logic.all.required.selected": "جميع الإجراءات المطلوبة محددة بالفعل.\nيمكنك إضافة هذا الإجراء بأمان.",
  ...
  "storage.delete.permanent.delete.confirm": "حذف \"{{name}}\" نهائياً؟ لا يمكن التراجع عن هذا الإجراء وسيحذف الملف من التخزين.",
  ...
  "email.template.plain.text.hint": "يُستخدم النص العادي لعملاء البريد الإلكتروني الذين لا يدعمون HTML",
  ...
  "form.builder.details.no.actions.available": "لا توجد إجراءات متاحة. قم بتكوين الإجراءات في وحدة IAM أولاً.",
  ...
  "form.builder.details.action.codes.required": "ستكون رموز الإجراءات هذه مطلوبة للوصول إلى النموذج",
  ...
  "form.builder.details.users.must.have.permission": "يجب أن يمتلك المستخدمون إحدى هذه الصلاحيات للإرسال",
  "form.builder.details.response.type": "نوع الاستجابة",
  "form.builder.details.response.mode.single.hint": "يمكن لكل مستخدم الإرسال مرة واحدة فقط. للمستخدمين المصادقين، يُفرض هذا بفحص الإرسالات الموجودة. للنماذج العامة، يستخدم هذا تخزين المتصفح.",
  ...
  "form.builder.public.access.restricted.description": "ليس لديك الصلاحيات المطلوبة لعرض أو إرسال هذا النموذج. يرجى الاتصال بالمسؤول إذا كنت تعتقد أن هذا خطأ.",
  "form.builder.public.login.required": "يتطلب هذا النموذج تسجيل الدخول.",
  "form.builder.public.permission.required": "يتطلب هذا النموذج صلاحيات محددة. يرجى تسجيل الدخول للمتابعة.",
  "form.builder.action.login.to.continue": "تسجيل الدخول للمتابعة",
  "form.builder.public.continue.your.draft": "متابعة مسودتك؟",
  "form.builder.public.draft.saved.description": "لديك مسودة محفوظة لهذا النموذج. هل تريد المتابعة من حيث توقفت؟",
  "form.builder.public.schema.change.warning": "ملاحظة: تم تحديث النموذج منذ حفظ مسودتك. قد تكون بعض الحقول قد تغيّرت.",
  ...
  "form.builder.toast.draft.not.saved.detail": "تعذر حفظ المسودة. قد يكون متصفحك في وضع التصفح الخاص أو التخزين ممتلئ.",
  ...
  "form.builder.result.version.notice": "تم هذا الإرسال بإصدار النموذج v{{submissionVersion}}. إصدار النموذج الحالي v{{currentVersion}}.",
  ...
  "form.builder.field.name.hint": "يُستخدم كمفتاح في بيانات الإرسال. يجب أن يكون فريداً في النموذج.",
  ...
  "form.builder.logic.conditional.rules.hint": "أضف قواعد للتحكم في الرؤية أو المتطلبات بناءً على قيم الحقول الأخرى.",
  ...
  "form.builder.logic.add.conditional.logic": "أضف منطقاً شرطياً للتحكم في متى يُعرض هذا الحقل أو يكون مطلوباً.",
  ...
  "form.builder.computed.define.fields": "حدد الحقول التي يتم حسابها من استجابات النموذج عند الإرسال",
  ...
  "form.builder.computed.rules.evaluation.order": "يتم تقييم القواعد بالترتيب. تُطبّق أول قاعدة مطابقة.",
  ...
  "translation.key.readonly.update.forbidden": "لا يمكن تعديل المفتاح أو الوحدة لمفاتيح ترجمة النظام",
  "translation.key.duplicate.key.in.module": "مفتاح الترجمة \"{{key}}\" موجود بالفعل في الوحدة \"{{module}}\"",
